...
// 下载地址
const fileDownloadUrl = process.env.DOWNLOAD_LINK;
 ...
 * @param filePath
 */
const downloadFileByUrl = (filePath) => {
...
export  { checkResponse, fileUploadUrl, fileSize, addtitle, downloadFile, downloadFileByUrl, downloadFileMining, parseDate, titleName, dateFormat, fileReviewUrl, pdfUrl}
