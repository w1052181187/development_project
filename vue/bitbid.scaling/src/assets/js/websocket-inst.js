...
export const WebPushSocket = (function () {
  let instance = null;
  return {
    getInstance: function (projectId, userId, userName, sendType, methodType, num = 1) {
      let uniqueId = '' + projectId + userId + num + methodType;
      if (instance === null || instance.uniqueId !== uniqueId) {
        instance = getWebsocketInstance(projectId, userId, userName, sendType, methodType, num);
      }
      return instance;
    }
  };
...
const getWebsocketInstance = function (projectId, userId, userName, sendType, methodType, num) {
  ...
  let webPushSocket = {
    ...
    heartCheck: null,
    uniqueId: '' + projectId + userId + num + methodType
  }
