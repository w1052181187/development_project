<template>
  <!-- 后台主容器 -->
  <div class="admin-layout" id="experteval-page">
    <div v-if="this.$route.path == '/admin/evaluate/experteval'">
      <div class="breadcrumb-mqh-tit">
        <el-breadcrumb separator="/">
          <el-breadcrumb-item :to="{ path: '/' }">首页</el-breadcrumb-item>
          <el-breadcrumb-item>考评系统</el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: '/admin/evaluate/experteval' }">评标专家考评</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <!--搜索区域start-->
      <div class="search-box experteval-search">
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button @click="handleTableClick(scope.row,'eval')" type="text" size="medium" v-if="$store.getters.permissions.includes('/evaluate/experteval/operation')">考评</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!-- 表格区域end -->
...
export default {
  ...
  methods: {
    ...
    handleTableClick (row, type) {
      this.$router.push({path: '/admin/evaluate/experteval/check', query: {code: row.code}})
    }
  },
  computed: {},
  // 实例创建完成
