  ...
  <div class="admin-layout" id="agent-details-page">
    <div class="breadcrumb-mqh-tit">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/admin/evaluate/proquery' }">项目单位考评</el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '/admin/evaluate/proquery/details' }">详情</el-breadcrumb-item>
      </el-breadcrumb>
...
export default {
  ...
  methods: {
    ...
    getEvaluateLabelList () {
      ...
      evaluateLabel.getListByRelatedCode(this.$route.query.code, 2).then((res) => {
    ...
    getProjectEvaluateInfo () {
      projectEvaluate.getOne(this.$route.query.code, 2).then((res) => {
