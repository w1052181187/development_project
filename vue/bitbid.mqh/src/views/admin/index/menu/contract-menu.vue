          ...
          <el-col :span="3" style="height:100%;position:fixed;width: 12.5%;">
            <div class="left-menu" style="height:100%">
              <el-menu
                ...
                <el-menu-item index="/admin/contract/contractrecord" class="menu-fisrt" v-if="$store.getters.permissions.includes('/contract/contractrecord')">
                  <i class="iconfont mqh-icon-dailishang"></i>
                  <span slot="title">合同备案</span>
                </el-menu-item>
                <el-menu-item index="/admin/contract/contractcheck" class="menu-fisrt" v-if="$store.getters.permissions.includes('/contract/contractcheck')">
                  <i class="iconfont mqh-icon-dailishang"></i>
                  <span slot="title">登记合同</span>
                </el-menu-item>
              </el-menu>
            </div>
          </el-col>
