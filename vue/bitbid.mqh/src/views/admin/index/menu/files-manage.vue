          ...
          <el-col :span="3" style="height:100%;position:fixed;width: 12.5%;">
            <div class="left-menu" style="height:100%">
              <el-menu
                ...
                <el-menu-item index="/admin/files/filemanage" class="menu-fisrt" v-if="$store.getters.permissions.includes('/files/filemanage')">
                  <i class="iconfont mqh-icon-approval" style="font-size:26px"></i>
                  <span slot="title">档案管理</span>
                </el-menu-item>
                <el-menu-item index="/admin/files/filequery" class="menu-fisrt" v-if="$store.getters.permissions.includes('/files/filequery')">
