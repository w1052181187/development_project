          ...
          <el-col :span="3" style="height:100%;position:fixed;width: 12.5%;">
            <div class="left-menu" style="height:100%">
              <el-menu
                ...
                <el-menu-item index="/admin/supply/supplypool" class="menu-fisrt" v-if="$store.getters.permissions.includes('/supply/supplypool')">
                  <i class="iconfont mqh-icon-dailishang"></i>
                  <span slot="title">供应商库</span>
                </el-menu-item>
                <el-menu-item index="/admin/supply/supplyblack" class="menu-fisrt" v-if="$store.getters.permissions.includes('/supply/supplypool')">
                  <i class="iconfont mqh-icon-dailishang"></i>
                  <span slot="title">供应商黑名单</span>
                </el-menu-item>
              </el-menu>
            </div>
          </el-col>
