          ...
          <el-col :span="3" style="height:100%;position:fixed;width: 12.5%;">
            <div class="left-menu" style="height:100%">
              <el-menu
                ...
                <el-menu-item index="/admin/record/processrecord" class="menu-fisrt" v-if="$store.getters.permissions.includes('/record/processrecord')">
                  <i class="iconfont mqh-icon-infoedit" style="font-size:26px"></i>
                  <span slot="title">招标过程备案</span>
                </el-menu-item>
                <el-menu-item index="/admin/record/infoconfirm" class="menu-fisrt" v-if="$store.getters.permissions.includes('/record/infoconfirm')">
                  <i class="iconfont mqh-icon-profilesetting" style="font-size:26px"></i>
                  <span slot="title">招标信息确认</span>
                </el-menu-item>
                <!--<el-menu-item index="/admin/record/resultquery" class="menu-fisrt" v-if="$store.getters.permissions.includes('/record/resultquery')">
                  <i class="iconfont mqh-icon-profilesetting" style="font-size:26px"></i>
                  <span slot="title">招标结果查询</span>
                </el-menu-item>-->
                <el-menu-item index="/admin/record/changequery" class="menu-fisrt" v-if="$store.getters.permissions.includes('/record/changequery')">
                  <i class="iconfont mqh-icon-profilesetting" style="font-size:26px"></i>
                  <span slot="title">招标变更查询</span>
                </el-menu-item>
              </el-menu>
            </div>
          </el-col>
