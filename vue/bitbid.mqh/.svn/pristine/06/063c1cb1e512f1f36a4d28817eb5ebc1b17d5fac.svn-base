<template>
  <!-- 后台主容器 -->
  <div class="admin-layout" id="agenteval-page">
    <div v-if="this.$route.path == '/admin/evaluate/agenteval'">
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button @click="handleTableClick(scope.row,'eval')" type="text" size="medium" v-if="$store.getters.permissions.includes('/evaluate/agenteval/operation')">考评</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!-- 表格区域end -->
