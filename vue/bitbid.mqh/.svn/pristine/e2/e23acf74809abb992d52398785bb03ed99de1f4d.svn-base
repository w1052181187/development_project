<template>
  <!-- 后台主容器 -->
  <div class="admin-layout" id="balancedetails-page">
    <div class="breadcrumb-mqh-tit">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/admin/planmanage/balancemanage/balancedetails' }">详情</el-breadcrumb-item>
      </el-breadcrumb>
    ...
    <div class="maincont-box">
      ...
      <div class="warp-balance">
        <h2>{{this.$route.query.year}}年资金平衡表</h2>
        <div>
        ...
        <el-table
          ...
          <el-table-column
            prop="inputData"
            :label="(this.$route.query.year - 1) + '年完成情况（万元）'"
            align="center">
          </el-table-column>
          <el-table-column
            :label="this.$route.query.year + '年资金平衡表'"
            align="center">
            <el-table-column
              prop="surplusFunds"
              :label= "'累计结余及' + (this.$route.query.year - 1) + '年提取数（万元）'"
              align="center">
            </el-table-column>
            <el-table-column
              prop="riskFunds"
            ...
            <el-table-column
              prop="availableFunds"
              :label="this.$route.query.year + '年建议计划可用资金（万元）'"
              align="center">
            </el-table-column>
          </el-table-column>
        </el-table>
    ...
    <div class="dialog-box">
      <el-dialog
        ...
        center>
        <div class="warp-balance">
          <h2 style="text-align: center;">{{this.$route.query.year}}年资金平衡表</h2>
          <div>
            <span class="balance-title right-title">专项资金风险控制比例：{{this.riskRatio}}%</span>
          </div>
          <el-table
...
export default {
  ...
  created () {
    // 获取列表数据
    // this.getEnterpriseClassify(this.$route.query.projectEnterpriseId, this.$route.query.code, this.specialFundsTableData, true)
    // 获取当前资金平衡表信息
  ...
  methods: {
    ...
    querySingleRecord (item) {
      ...
      // this.getEnterpriseClassify(this.currentBalanceSheetInfo.balanceSheet.enterpriseId, item.relatedBalanceSheetCode, this.dialogFundsTableData, false)
