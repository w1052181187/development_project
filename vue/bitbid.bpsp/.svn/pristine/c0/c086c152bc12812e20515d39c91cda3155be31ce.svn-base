    ...
    <div class="contentbigbox">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="图片:" prop="fileInformations">
          <upload-file @upLoadFile="upLoadFile" :fileType="fileType" :oldFileName="oldFileName" :relativePath="relativePath" :isImage="isImage"></upload-file>
        </el-form-item>
        <el-form-item>
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        url: [
          // { required: false, message: '请填写URL地址', trigger: 'blur' },
          {validator: validUrl, trigger: ['blur', 'change'], required: false}
        ],
        fileInformations: [
