<template>
  <div id="ckresultannodetail" class="smaincontent">
    <div class="headertitle">
      <!--面包屑-->
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/main' }">首页</el-breadcrumb-item>
        <el-breadcrumb-item>公告审核</el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '/annoapprove/ckresultanno' }">成交公示审核</el-breadcrumb-item>
        <el-breadcrumb-item>查看成交公示</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
        ...
        <el-form :model="winBidForm" ref="winBidForm">
          <table class="detailtable">
            ...
            <tr>
              <td>发布频道：</td>
              <td  colspan="2">
                <span v-if="winBidForm.tenderExpandsInfo.type === 4">成交公示</span>
...
export default {
  ...
  methods: {
    ...
    close () {
      this.$router.push({path: '/annoapprove/ckresultanno', query: {status: this.status}})
    }
  },
  mounted () {
