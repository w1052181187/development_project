  ...
  <div id="ad-manage">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>合作单位</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
    <div class="contentbigbox">
      <!--搜索 & 添加按钮-->
      <el-row>
        <el-button type="success"  class="addbutton" @click="addbutton"> + 添加合作单位</el-button>
...
export default {
  ...
  methods: {
    ...
    /** 新增 */
    addbutton () {
      this.$router.push({path: '/index/cooperation/add'})
    },
    /** 表格操作按钮 */
    handleTableBtn (row, type) {
      if (Object.is(type, 'del')) {
        ...
        this.$router.push({path: '/index/cooperation/update', query: {objectId: row.objectId}})
      }
    },
    /** 删除 */
    delete (row) {
