<template>
  <div id="ckpurchase" class="smaincontent">
    <div class="headertitle">
      <!--面包屑-->
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/main' }">首页</el-breadcrumb-item>
        <el-breadcrumb-item>公告审核</el-breadcrumb-item>
        <el-breadcrumb-item>采购公告审核</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    // 审核
    checkBtn (scope) {
      this.$router.push({path: '/annoapprove/ckpurchase/check', query: {objectId: scope.row.object_id, status: this.status}})
    },
    // 查看
    detailBtn (scope) {
      this.$router.push({path: `/annoapprove/ckpurchase/detail/${scope.row.object_id}`, query: {status: this.status}})
    },
    // 撤回
    withdraw (scope) {
