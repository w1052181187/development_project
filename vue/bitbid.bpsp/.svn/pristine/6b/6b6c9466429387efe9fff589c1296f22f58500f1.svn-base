  ...
  <div id="resultannoadd" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>添加成交公示</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
...
export default {
  ...
  methods: {
    ...
    submitForm (name, status) {
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          purchase.save(this.winBidForm).then((res) => {
    ...
    purchaseDetail () {
      purchase.detail(this.$route.params.objectId).then((res) => {
        this.disableFlag = true
        this.winBidForm.relatedCode = res.data.purchaseBulletin.code
        this.winBidForm.tenderProjectCode = res.data.purchaseBulletin.tenderProjectCode
        this.winBidForm.tenderExpandsInfo = res.data.purchaseBulletin.tenderExpandsInfo
        this.winBidForm.tenderExpandsInfo.objectId = null
        this.winBidForm.tenderExpandsInfo.type = null
