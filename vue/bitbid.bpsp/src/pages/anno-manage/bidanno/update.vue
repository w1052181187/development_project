  ...
  <div id="bidannoupdate" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>修改招标公告</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
  ...
  methods: {
    detail () {
      bidanno.detail(this.$route.query.objectId).then((res) => {
        ...
        if (res.data.tenderBulletin.fileInformations.length !== 0) {
          this.oldFileName = res.data.tenderBulletin.fileInformations[0].fileName
          this.relativePath = res.data.tenderBulletin.fileInformations[0].relativePath
        }
    ...
    upLoadFile (file) {
      if (file.length === 0) {
        ...
        this.tenderBulletin.fileInformations[0].businessType = 5
      }
    },
