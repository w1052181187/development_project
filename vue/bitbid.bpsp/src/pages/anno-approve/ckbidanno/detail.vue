<template>
  <div id="ckbidannodetail" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>查看招标公告</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      ...
      <template>
        <el-form :model="tenderBulletin" ref="tenderBulletins">
          ...
          <tr>
            ...
            <td>发布频道：</td>
            <td  colspan="2">
              <span v-if="tenderBulletin.tenderExpandsInfo.type === 1">招标公告</span>
          ...
          <approverecord v-if="tenderBulletin.status === 2 || tenderBulletin.status === 3 || tenderBulletin.status === 4" :code="tenderBulletin.code"></approverecord>
        </table>
        </el-form>
      </template>
    </div>
  ...
  methods: {
    detail () {
      bidanno.detail(this.$route.params.objectId).then((res) => {
        ...
        this.fileObject = res.data.tenderBulletin.fileInformations.length === 0 ? null : res.data.tenderBulletin.fileInformations[0]
