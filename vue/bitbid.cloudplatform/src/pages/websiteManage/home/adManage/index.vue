<template>
  <div class="cloudcontent" id="cloud_webhome">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
      ...
      <el-breadcrumb-item class="active_bread">广告管理</el-breadcrumb-item>
    </el-breadcrumb>
    <!--面包屑-->
    <div class="main">
      <div class="topmain">
...
export default {
  ...
  methods: {
    // 添加
    addBtn () {
      this.$router.push({path: '/websiteManage/home/adManage/add'})
    },
    // 修改
    updateBtn (scope) {
      this.$router.push({path: `/websiteManage/home/adManage/update`, query: {objectId: scope.row.objectId}})
    },
    // 查看
    lookBtn () {
