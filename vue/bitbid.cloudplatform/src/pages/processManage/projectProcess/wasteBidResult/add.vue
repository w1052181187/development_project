<template>
  <div class="cloudcontent" id="cloud_processedit">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
      ...
      <el-breadcrumb-item :to="{ path: '/processManage/projectProcess/project/process' }">废标结果公告</el-breadcrumb-item>
      <el-breadcrumb-item class="active_bread">添加修改废标结果公告</el-breadcrumb-item>
    </el-breadcrumb>
    <!--面包屑-->
    <div class="main">
...
import {bulletinInfo, bidSection} from '@/api/cloudplatform/index'
export default {
  components: {
    editor,
    uploadFile
