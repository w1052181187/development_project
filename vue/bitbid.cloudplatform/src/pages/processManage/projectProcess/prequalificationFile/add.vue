<template>
  <div class="cloudcontent">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
      ...
      <el-breadcrumb-item :to="{ path: '/processManage/projectProcess/project/process', query: {type: 'pre_file'} }">资格预审文件</el-breadcrumb-item>
      <el-breadcrumb-item class="active_bread">添加资格预审文件</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="main">
    ...
    submit (form, status) {
      ...
      this.$refs[form].validate((vaild) => {
        if (vaild) {
          ...
          this.updateForm.documentReleaseTime = new Date(this.updateForm.documentReleaseTime).getTime()
