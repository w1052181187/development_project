...
export default{
  ...
  methods: {
    ...
    addCharge () {
      this.$router.push({path: '/projectpayments/manage/other-expenditure/add', query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, costTypes: this.$route.query.costTypes, expenseId: this.$route.query.expenseId}})
    },
    editBtn (scope) {
      this.$router.push({path: '/projectpayments/manage/other-expenditure/update', query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, costTypes: this.$route.query.costTypes, objectIds: scope.row.objectId, expenseId: this.$route.query.expenseId}})
    },
    lookBtn (scope) {
      this.$router.push({path: `/projectpayments/manage/other-expenditure/detail/${scope.row.objectId}`, query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, costTypes: this.$route.query.costTypes, objectIds: scope.row.objectId, expenseId: this.$route.query.expenseId}})
    },
    // 删除
    deleteObject (scope) {
