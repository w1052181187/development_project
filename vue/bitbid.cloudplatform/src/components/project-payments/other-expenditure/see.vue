    ...
    <div id="addItembid" class="content_bigbox">
      ...
      <el-row style="margin-top:48px">
        <el-form :model="ruleForm" label-width="160px">
          <el-col :span="24">
            <el-form-item label="支出项目：" prop="paymentUnitName" class="bitianicon">
              <el-input class="el-inputbox" v-model="ruleForm.paymentUnitName" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="金额(元)：" prop="surrenderValue" class="bitianicon">
              <el-input v-model="ruleForm.surrenderValue" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="支出方式：" prop="paymentType" class="bitianicon">
