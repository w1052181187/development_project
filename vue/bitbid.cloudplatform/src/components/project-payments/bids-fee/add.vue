  ...
  <div>
    <div id="addItembid" class="content_bigbox">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
        ...
        <el-breadcrumb-item>
          <router-link to="/projectpayments">项目收支管理</router-link>
        </el-breadcrumb-item>
        <el-breadcrumb-item>
          <router-link :to="{path:'/projectpayments/manage/biddocumentlist',query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, costTypes:  this.$route.query.costTypes, expenseId: this.$route.query.expenseId}}">
        ...
        <el-form :model="ruleForm"  ref="ruleForm" :rules="rules"  label-width="160px">
          <el-col :span="24">
            <el-form-item label="缴费单位：" class="bitianicon">
              ...
              <el-dialog title="选择缴费单位" :visible.sync="dialogFormVisible" width="40%">
          ...
          <el-col :span="24">
            <el-form-item label="缴费标段：" class="jfbd_box bitianicon">
              <el-tag
          ...
          if (valid) {
            ...
            if (this.ruleForm.paymentUnitName === '') {
              ...
              this.axios.post('charge', this.ruleForm).then((res) => {
                this.$router.push({path: '/projectpayments/manage/biddocumentlist', query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, costTypes: this.$route.query.costTypes, expenseId: this.$route.query.expenseId}})
              })
            }
          } else {
            return false
