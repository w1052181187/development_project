  ...
  <div>
    <div id="seeItem" class="content_bigbox">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
        ...
        <el-breadcrumb-item><router-link to="/projectpayments">项目收支管理</router-link></el-breadcrumb-item>
          ...
          <el-form :model="ruleForm" label-width="160px">
            ...
            <el-col :span="24">
              <el-col :span="12">
                <el-form-item label="招标方式：" prop="bidType">
                  <el-select class="zzt_zbfs_selectbox" v-model="ruleForm.bidType" placeholder="请选择招标方式" disabled>
                    <el-option
              ...
              <el-col :span="12">
                <el-form-item v-show='ruleForm.bidType=="0"' label="资审方式：" prop="inforOnMethod">
                  <el-select class="zzt_zbfs_selectbox" v-model="ruleForm.inforOnMethod" placeholder="请选择资审方式" disabled>
                    <el-option
            ...
            <el-col :span="12">
              <el-form-item label="项目经理：">
                <el-input v-model="projectManagers" readonly></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="所属部门：">
                <el-input v-model="departments" readonly></el-input>
              </el-form-item>
            </el-col>
          </el-form>
      </el-row>
  ...
  methods: {
    ...
    deptManagerhebibi () {
      useradmin.deptManagerlist(this.$store.getters.authUser.userId).then((res) => {
        this.projectManagers = res.data.user.name
        this.departments = res.data.user.dept.name
      })
    },
    // 标段列表接口
