          ...
          <el-form :model="form" :rules="rules" ref="form" status-icon class="demo-ruleForm">
            <el-col :span="12">
              <el-form-item  label="标段编号：" prop="sectionNumber" :label-width="formLabelWidth">
                <el-input  v-model="form.sectionNumber" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <div class="grid-content bg-purple">
                <el-form-item  label="标段名称：" prop="sectionName" :label-width="formLabelWidth">
                  <el-input :title="form.sectionName" v-model="form.sectionName" disabled></el-input>
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="12">
              <el-form-item label="招标项目编号：" prop='proTenderNumber' :label-width="formLabelWidth">
                <el-input v-model="form.proTenderNumber"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <div class="grid-content bg-purple">
                <el-form-item label="招标项目名称：" prop='proTenderName' :label-width="formLabelWidth">
                  <el-input v-model="form.proTenderName"></el-input>
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="24">
              <el-col :span="12">
                <el-form-item prop="sectionType" :model="form" label="标段类型："  :label-width="formLabelWidth">
                  <el-cascader
            ...
            <el-col :span="24">
              <el-col :span="12">
                <div class="grid-content bg-purple">
                  <el-form-item :model="form" prop="bidsMethod" label="招标方式：" :label-width="formLabelWidth">
                    <el-select class="zzt_zbfs_selectbox" v-model="form.bidsMethod" placeholder="请选择招标方式" @change="bidsMethodSelect">
                      <el-option
              ...
              <el-col :span="12">
                <el-form-item v-show='form.bidsMethod=="0"' ref="inforOnMethod" label="资审方式：" prop="inforOnMethod" :label-width="formLabelWidth">
                  <el-select class="zzt_zbfs_selectbox" v-model="form.inforOnMethod" placeholder="请选择资审方式">
                    <el-option
            ...
            <el-col :span="24">
              <el-col :span="12">
                <el-form-item label="是否委托招标代理：" prop="isEntrustAgency" class="bdlxtitle" :label-width="formLabelWidth">
                  <el-select class="sfwtdl_btn" v-model="form.isEntrustAgency" placeholder="请选择是否委托" @change="isEntrustAgencySelect">
                    <el-option
              ...
              <el-col :span="12">
                <el-form-item v-show="form.isEntrustAgency=='1'" ref="agentStructure" label="代理机构：" prop="agentStructure" :label-width="formLabelWidth">
                  <el-input v-model="form.agentStructure"></el-input>
                </el-form-item>
              </el-col>
            </el-col>
            <el-col :span="12">
              <div class="grid-content bg-purple">
                <el-form-item label="项目经理：" prop="projectManager" :label-width="formLabelWidth">
                  <el-input v-model="form.projectManager" readonly v-if="this.$route.query.editStatus"></el-input>
                  <el-select class="zzt_zbfs_selectbox"  v-model="form.projectManager" placeholder="请选择" v-else>
                    <el-option
            ...
            <el-col :span="12">
              <el-form-item label="所属部门：" prop="department" :label-width="formLabelWidth">
                <el-input v-model="form.department" readonly v-if="this.$route.query.editStatus"></el-input>
                <el-select class="zzt_zbfs_selectbox"  v-model="form.department" placeholder="请选择" v-else>
                  <el-option
...
export default {
  data () {
    return {
      form: {
        sectionNumber: this.$route.query.sectionNumber, // 标段编号
        sectionName: this.$route.query.sectionName, // 标段名称
        proTenderNumber: '',
        proTenderName: '',
        sectionType: '',
        bidsMethod: '',
  ...
  methods: {
    postData (formName, flag) {
      ...
      if (this.$route.query.editStatus) {
        this.form.projectManager = this.editprojectManagerId
        this.form.department = this.editdepartmentId
      }
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.axios.post('project-infos', this.form).then((res) => {
            if (flag == 0) {
              this.addObject = res.data.projectInformation.objectId
              this.$router.push({path: '/archives/archived-file', query: {objectId: this.addObject, btn: true, inforOnMethod: this.form.inforOnMethod, deptName: this.$route.query.deptName, managerName: this.$route.query.managerName, editStatus: true}})
              this.form.projectManager = this.$route.query.managerName
              this.form.department = this.$route.query.deptName
            } else {
    ...
    formData () {
      this.axios.get(`project-infos/${this.$route.query.objectId}`).then((res) => {
        ...
        this.editprojectManagerId = res.data.projectInformation.projectManager
        this.editdepartmentId = res.data.projectInformation.department
        this.form.projectManager = this.$route.query.managerName
        this.form.department = this.$route.query.deptName
      })
    },
