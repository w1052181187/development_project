      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" @click="updateBtn(scope)" v-if="scope.row.status === 0 || scope.row.status === 2">编辑</el-button>
            <el-button type="text" size="small" @click="delBtn(scope)" v-if="scope.row.status === 0 || scope.row.status === 2">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--分页-->
