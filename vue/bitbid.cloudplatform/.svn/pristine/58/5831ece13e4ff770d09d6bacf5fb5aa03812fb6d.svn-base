              ...
              <el-table
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    {{scope.row.serviceStatus=='0'?'已开通':'未开通'}}
                  </template>
                </el-table-column>
                <el-table-column
                  prop="serviceEndDate"
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    <el-button type="danger" size="small" v-if="scope.row.serviceStatus === 0" @click="renewBtn">续费</el-button>
                    <el-button type="primary"  @click="Openup" v-else>立即开通</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </template>
  ...
  methods: {
    openServiceList () {
      ...
      opens.openList(url).then((res) => {
        console.log(res)
        console.log(res.data.managementList)
