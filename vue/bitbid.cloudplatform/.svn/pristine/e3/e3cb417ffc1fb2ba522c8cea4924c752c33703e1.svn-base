  ...
  <div>
    <div id="addItembid" class="content_bigbox">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
        ...
        <el-breadcrumb-item>
          <router-link :to="{path:'/projectpayments/manage/bondlist',query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, costTypes:  this.$route.query.costTypes, expenseId: this.$route.query.expenseId}}">
          ...
          if (valid) {
            ...
            if (this.ruleForm.paymentUnitName === '') {
              ...
              this.axios.post('charge', this.ruleForm).then((res) => {
                this.$router.push({path: '/projectpayments/manage/bondlist', query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, costTypes: this.$route.query.costTypes, expenseId: this.$route.query.expenseId}})
              })
            }
          } else {
            return false
