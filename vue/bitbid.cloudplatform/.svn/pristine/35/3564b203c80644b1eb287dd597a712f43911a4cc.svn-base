                  ...
                  <el-col :span="12">
                    <div class="grid-content bg-purple">
                      <el-form-item label="项目经理：" :label-width="formLabelWidth">
                        <el-input v-model="form.projectManager" readonly></el-input>
                      </el-form-item>
                    </div>
                  </el-col>
                  <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    // 归档文件
    filTypep () {
      this.axios.get(`file-types?pageNo=${this.pageNo}&pageSize=${this.pageSize}&projectObjectId=${this.$route.query.objectId}`).then((res) => {
