<template>
  <div class="cloudcontent" id="cloud_webhome">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
      ...
      <el-breadcrumb-item :to="{ path: '/websiteManage/home' }">网站首页管理</el-breadcrumb-item>
      <el-breadcrumb-item :to="{ path: '/websiteManage/home/enterpriseImage' }">企业图片</el-breadcrumb-item>
      <el-breadcrumb-item class="active_bread">添加企业图片</el-breadcrumb-item>
    </el-breadcrumb>
    <!--面包屑-->
    <div class="main">
      <el-form :model="updateForm" :rules="rules" ref="updateForm" :validate-on-rule-change="true">
        <el-row>
          <el-col :span="12">
            <el-form-item label="企业图片名称："  prop="agencyContractCode">
        ...
        <el-row>
          <el-form-item label="">
            <el-col style="color: #ff0000;">注：建议图片尺寸：宽509px，高311px</el-col>
          </el-form-item>
        </el-row>
