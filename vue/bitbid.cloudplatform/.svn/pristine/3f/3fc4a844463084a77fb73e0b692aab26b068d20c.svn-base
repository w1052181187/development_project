      ...
      <div class="homepageconright">
        <div class="logonewsbigbox">
          <div class="logocompany_bigbox">
            ...
            <div class="company_box">
              <span class="companname">山西广信建设项目管理有限公司</span>
              <br>
              <span>山西太原/shanxitaiyuan </span>
            </div>
          </div>
          <div class="news_bgibox">
            <div class="newsbox">
              <span class="newstitle">我的积分</span>
              <br>
              <span class="newsnumber">56</span>
            </div>
            <div class="xianbox"></div>
            <div class="newsbox">
              <span class="newstitle">我的消息</span>
              <br>
              <span class="newsnumber">10</span>
            </div>
          </div>
        </div>
                    ...
                    <el-row :gutter="20">
                      <el-col :span="6" class="grid-contentbox">
                        <div class="grid-content bg-purple">
                          <div class="gridtitlebox">项目管理</div>
                          <div class="gridimgbox">
                            <img src="../../../static/images/xmgl.svg" alt="" v-if="xmglshowStatus">
                            <img src="../../../static/images/xmgl1.svg" alt="" v-else>
                          </div>
                          <div class="gridmiaoshu">实现招标采购全过程有效组织、协调、监督和管理。</div>
                          <div class="immediatelybtn" @click="immediatelyBtn" v-if="xmglshowStatus">立即开通</div>
                          <div class="renewbtn" @click="renewBtn" v-else>立即续费</div>
                        </div>
                      </el-col>
                      <el-col :span="6" class="grid-contentbox">
                        <div class="grid-content bg-purple">
                          ...
                          <div class="gridimgbox">
                            <img src="../../../static/images/dagl1.svg" alt="" v-if="daglshowStatus">
                            <img src="../../../static/images/dagl2.svg" alt="" v-else>
                          </div>
                      ...
                      <el-col :span="6" class="grid-contentbox">
                        <div class="grid-content bg-purple">
                          ...
                          <div class="gridimgbox">
                            <img src="../../../static/images/yzgl1.svg" alt="" v-if="yzglshowStatus">
                            <img src="../../../static/images/yzgl2.svg" alt="" v-else>
                          </div>
                      ...
                      <el-col :span="6" class="grid-contentbox">
                        <div class="grid-content bg-purple">
                          ...
                          <div class="gridimgbox">
                            <img src="../../../static/images/zjgl1.svg" alt="" v-if="zjglshowStatus">
                            <img src="../../../static/images/zygl3.svg" alt="" v-else>
                          </div>
                    ...
                    <el-row :gutter="20">
                      <el-col :span="6" class="grid-contentbox">
                        <div class="grid-content bg-purple">
                          ...
                          <div class="gridimgbox">
                            <img src="../../../static/images/xmsz.svg" alt="" v-if="szglshowStatus">
                            <img src="../../../static/images/xmsz1.svg" alt="" v-else>
                          </div>
                ...
                <el-carousel indicator-position="outside" :autoplay="true">
                  <el-carousel-item>
                    <el-row :gutter="20">
                      <el-col :span="6" class="grid-contentbox">
                        <div class="grid-content bg-purple">
                          <div class="gridtitlebox">质疑设置</div>
                          <div class="gridimgbox">
                            <img src="../../../static/images/zygl.svg" alt="" v-if="zyszshowStatus">
                            <img src="../../../static/images/zygl2.svg" alt="" v-else>
                          </div>
        ...
        <div class="servicebigbox">
          <div class="servicetitlebox">
            <span>我的消息 · </span>
            <span>10</span>
            <router-link :to="''" class="gengduo">更多</router-link>
          </div>
          <div class="newsconbigbox">
            <div class="newsconbox" v-for="(item,index) in news" :key="index">
              <el-row>
                <el-col :span="6">
                  <div class="grid-contentnewsbox">{{item.nesname}}</div>
                </el-col>
                <el-col :span="12">
                  <div class="grid-contentnewsbox">{{item.nescon}}</div>
                </el-col>
                <el-col :span="6">
                  <div class="grid-contentnewsbox">{{item.nestimes}}</div>
                </el-col>
              </el-row>
            </div>
          </div>
    ...
    opensList () {
      ...
      admins.openList(url).then((res) => {
        res.data.managementList.map((ite) => {
          ...
          } else if (ite.isChecked === 1 && ite.serviceName === '项目管理设置') {
            this.xmglshowStatus = false
          }
        })
      })
    },
