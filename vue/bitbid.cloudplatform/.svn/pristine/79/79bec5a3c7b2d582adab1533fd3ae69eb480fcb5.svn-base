...
export default {
  data () {
    ...
    return {
      ...
      dynamicTags: this.$route.query.data.row.professionalQualifications,
      // 级联选择数据
  ...
  created: function () {
    // 专业分类
    this.selectedOptions = this.$route.query.data.row.expertClassifyStandard.split(',')
    // 三级联动
