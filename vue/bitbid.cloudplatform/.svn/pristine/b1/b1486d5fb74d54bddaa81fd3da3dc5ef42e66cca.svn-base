  ...
  <div class="cloudcontent" id="cloud_processedit">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
      ...
      <template v-else>
        ...
        <el-breadcrumb-item class="active_bread">查看中标候选人公示疑义及澄清</el-breadcrumb-item>
      </template>
    </el-breadcrumb>
    <!--面包屑-->
    <div class="main">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="疑义附件：">
              <el-table
                :data="updateForm.objectionFileList"
                border
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="澄清附件：">
              <el-table
                :data="updateForm.clarifyFileList"
                border
                style="width: 100%" header-cell-class-name="tableheader">
                <el-table-column
                  type="index"
    ...
    getQuesAndAnsInfo () {
      questionAndAnswerInfo.getById(this.$route.params.objectId).then(res => {
        ...
        if (this.updateForm.fileInformationList) {
          this.updateForm.objectionFileList = []
          this.updateForm.clarifyFileList = []
          this.updateForm.fileInformationList.map(file => {
            if (Object.is(file.businessType, '1')) {
              this.updateForm.objectionFileList.push(file)
            } else if (Object.is(file.businessType, '2')) {
              this.updateForm.clarifyFileList.push(file)
            }
          })
        }
      })
