<template>
  <div class="cloudcontent" id="cloud_webhome">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
      ...
      <el-breadcrumb-item class="active_bread">企业图片</el-breadcrumb-item>
    </el-breadcrumb>
    <!--面包屑-->
    <div class="main">
      <div class="topmain">
...
export default {
  ...
  methods: {
    // 添加
    addBtn () {
      this.$router.push({path: '/websiteManage/home/enterpriseImage/add'})
    },
    // 修改
    updateBtn (scope) {
      this.$router.push({path: `/websiteManage/home/enterpriseImage/update`, query: {objectId: scope.row.objectId}})
    },
    // 查看
    lookBtn () {
