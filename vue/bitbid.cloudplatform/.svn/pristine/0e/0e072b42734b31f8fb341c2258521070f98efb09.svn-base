  ...
  <div class="cloudcontent" id="cloud_processtype">
    ...
    <div class="box">
      <div class="topmain">
        中标候选人公示疑义及澄清
        <!--按钮-->
        <el-button class="addbutton" @click="addWinbidclearBtn()" v-if="operationFlag">
          <span> + 添加</span>
        </el-button>
        <!--按钮-->
      </div>
    ...
    <div class="box">
      <div class="topmain">
        中标通知书
        <!--按钮-->
        <el-button class="addbutton"  @click="addWinbidinformBtn()" v-if="operationFlag">
          <span> + 添加</span>
        </el-button>
        <!--按钮-->
      </div>
    ...
    <div class="box">
      <div class="topmain">
        招标结果通知书
        <!--按钮-->
        <el-button class="addbutton" @click="addTenderinformBtn()" v-if="operationFlag">
          <span> + 添加</span>
        </el-button>
        <!--按钮-->
      </div>
  ...
  methods: {
    ...
    getQuesAndAnsInfoList () {
      let query = {
        ...
        tenderSystemCode: this.chooseSectionSystemCode ? this.chooseSectionSystemCode : this.sectionSystemCode,
