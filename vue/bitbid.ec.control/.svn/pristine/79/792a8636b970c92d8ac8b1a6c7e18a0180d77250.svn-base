  ...
  <el-col :span="3" style="height: 100%;background-color: rgb(25, 35, 60);">
    ...
    <el-scrollbar style="height: 100%;">
      <el-menu
        ...
        <el-submenu index="8" v-if="users.userType===2 || users.userType===1">
          <template slot="title">
            <span class="iconimg">
        ...
        <el-submenu index="6" v-if="users.userType===4">
          <template slot="title">
            <span class="iconimg">
        ...
        <el-submenu index="7" v-if="users.userType===3">
          <template slot="title">
            <span class="iconimg">
