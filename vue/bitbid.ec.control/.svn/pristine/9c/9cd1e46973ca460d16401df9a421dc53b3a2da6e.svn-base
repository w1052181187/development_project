  ...
  <div id="ecadmin-page"  class="cont-view">
    ...
    <div class="bread-box">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>电商管理员管理</el-breadcrumb-item>
      ...
      <el-dialog
        ...
        <el-form :model="submitForm" :rules="rules" ref="submitForm" label-width="110px" class="demo-ruleForm">
          ...
          <el-form-item label="位置选择:" prop="priorityOrder">
            <el-select v-model="submitForm.priorityOrder" clearable placeholder="请选择">
              <el-option
...
export default {
  ...
  methods: {
    ...
    addAccount () {
      ...
      this.titleName = '新增'
      this.isEdit = false
      if ((this.tableData.length + 1) > this.positionSelectList.length) {
        let temArr = []
        this.tableData.forEach(item => {
          temArr.push(item.priorityOrder)
        })
        this.positionSelectList = []
        console.log(temArr)
        this.tableData.forEach((item, index) => {
          if (temArr.includes(item.priorityOrder)) {
        ...
        this.positionSelectList.push(
          {
            value: this.tableData.length + 1,
            label: this.tableData.length + 1 + '号'
          }
        )
      }
    },
