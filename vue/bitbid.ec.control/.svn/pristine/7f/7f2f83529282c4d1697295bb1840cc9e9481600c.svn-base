<template>
  <div id="protal-deal-notice-page" class="cont-view">
    <!-- 面包屑区域start -->
    <div class="bread-box">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/' }">首页</el-breadcrumb-item>
        <el-breadcrumb-item>门户信息管理</el-breadcrumb-item>
        <el-breadcrumb-item>成交公示管理</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 面包屑区域end -->
    <!-- 搜索区域start -->
  ...
  methods: {
    ...
    handleTableBtn (row, type) {
      ...
      if (Object.is(type, 'back')) {
        ...
        this.$router.push({path: `/index/dealdetails/${row.id}`})
      }
    },
    // 处理撤回 恢复 移除
