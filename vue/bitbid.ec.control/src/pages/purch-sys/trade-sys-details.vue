<template>
  <div id="trade-sys-details-page"  class="cont-view">
    <!-- 面包屑区域start -->
    <div class="bread-box">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/' }">首页</el-breadcrumb-item>
        <el-breadcrumb-item>采购管理系统</el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '/index/purchsys-trade-record' }">交易记录管理</el-breadcrumb-item>
