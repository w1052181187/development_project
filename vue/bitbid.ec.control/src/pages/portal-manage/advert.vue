    ...
    <div class="search-box">
      <el-row :gutter="20">
        ...
        <el-col :span="16" class="add-btn">
          <el-button type="primary" size="small" @click="addAd" style="float:right;">新 增</el-button>
        </el-col>
      </el-row>
    </div>
    <!-- 搜索区域end -->
    ...
    <div class="dialog-box">
      <el-dialog
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="图片:" prop="adPic">
            <upload-file
            ...
            <input type="text" v-if="ruleForm.fileInformationList.length" v-model="ruleForm.adPic" style="display:none;">
            <p style="color:#999;position:absolute;margin-top:45px;">建议上传图片尺寸：290px*111px”</p>
          </el-form-item>
        </el-form>
      ...
      <el-dialog
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item label="链接地址:">
            <span>{{ruleForm.linkUrl}}</span>
          </el-form-item>
          <el-form-item label="图片:" v-if="ruleForm.fileInformationList.length">
            <fileDownload
              :fileObject="ruleForm.fileInformationList[0]">
            </fileDownload>
          </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    uploadOtherSuccess (file) {
      ...
      this.$set(this.ruleForm, 'adPic', [file][0].fileName)
    ...
    getTableData () {
      ...
      ad.queryList(this.searchForm).then(res => {
        this.tableData = res.data.adPageInfo.list
        this.page.total = res.data.adPageInfo.total
      })
    },
    /** 新增 */
    addAd () {
    ...
    handleTableBtn (row, type) {
      if (Object.is(type, 'look')) {
        ...
        this.$nextTick(() => {
          this.ruleForm.fileInformationList.push(fileObj)
          this.$set(this.ruleForm, 'adPic', row.fileName)
        })
