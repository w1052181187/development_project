    ...
    <div class="setup_bigbox">
      ...
      <!--<div class="operation_bigbox">-->
        ...
        <!--<div class="operation_content">-->
          <!--<span>如果所有评委都提交完成，以及其他的工作都完成之后，就可以“结束本次评标”了。在下达这个命令之后，这个工程将会进入历史工程，不再显示出来。</span>-->
        <!--</div>-->
      <!--</div>-->
      <!--操作说明-->
    </div>
...
export default {
  ...
  methods: {
    // 查询下达状态
    inquiryDownStatus () {
      reviewControl.retrialCommandEnd().then((res) => {
    ...
    downEndBtn () {
      reviewControl.douwnEndTrial().then((res) => {
