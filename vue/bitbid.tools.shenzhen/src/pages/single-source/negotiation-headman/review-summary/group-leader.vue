...
import summaryCommon from '@/components/common/single-source/summary'
import negotiationSummary from '@/components/common/single-source/negotiation-summary'
import finalReview from '@/components/common/single-source/final-review'
