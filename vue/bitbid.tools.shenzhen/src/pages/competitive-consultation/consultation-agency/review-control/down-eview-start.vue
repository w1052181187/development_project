  ...
  <div id="goDownStartEview" class="content_bgibox">
    ...
    <div class="setup_bigbox">
      <div class="proinfobox">
        ...
        <span class="title_bigbox">下达开始评标命令</span>
      </div>
      <el-button type="success" class="go_down_btnbox" @click="downBtn" v-if="!orderStatus">下达开始评标命令</el-button>
      <el-button type="success" class="go_down_btnbox" disabled v-else>已下达评标命令</el-button>
      <!--操作说明-->
