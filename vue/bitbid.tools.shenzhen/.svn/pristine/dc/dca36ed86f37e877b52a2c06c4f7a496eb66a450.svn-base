  ...
  <div id="negSumm" class="content_bgibox negSummbigbox">
    <el-row>
      ...
      <el-col :span="20" class="negSummrightbox">
        ...
        <bidNegotiationSummary v-if="flagShow === 2" :negName="negName" :frequency="frequency" :lefNavArry="lefNavArry" :checkType = "type"></bidNegotiationSummary>
...
import bidSummaryCommon from '@/components/common/single-source/bid-summany'
import bidNegotiationSummary from '@/components/common/single-source/bid-negotiation-summary'
import bidFinalReview from '@/components/common/single-source/bid-final-review'
