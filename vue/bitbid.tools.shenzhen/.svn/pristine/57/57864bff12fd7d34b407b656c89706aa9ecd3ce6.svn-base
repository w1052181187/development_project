      ...
      <el-col :span="10">
        ...
        <div class="setup_bigbox">
          ...
          <div class="type_selectbox">
            <div class="type_selecttitle">询价供应商：</div>
          ...
          <div class="tableDataSupplier_box">
            <el-table
              ...
              <el-table-column
                prop="checkDesc"
                label="是否合格" align="left" width="120">
...
export default {
  ...
  methods: {
    ...
    negotiatingSuppliersSeleList () {
      review.negotiatingSuppliersSele(this.reviewType).then((res) => {
    ...
    negotiatingSuppliersTable () {
      ...
      review.negotiatingSuppliersList(url).then((res) => {
    ...
    changeStatusQualified (scope) {
      ...
      if (scope.row.checkDesc === '不合格') {
        ...
        review.preservationUnqualified(reasonData).then(() => {
          this.negotiatingSuppliersTable()
        })
      }
    },
    ...
    confirmationBtns (unqualifiedForm) {
      this.$refs[unqualifiedForm].validate((valid) => {
        if (valid) {
          ...
          review.preservationUnqualified(reasonData).then((res) => {
            this.negotiatingSuppliersTable()
            this.dialogFormVisible = false
