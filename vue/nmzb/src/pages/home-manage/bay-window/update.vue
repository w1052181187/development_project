  ...
  <div id="rotate-add" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/index/home-manage/bay-window' }">会员单位</el-breadcrumb-item>
        <el-breadcrumb-item>编辑会员单位</el-breadcrumb-item>
      </el-breadcrumb>
      ...
      this.$refs[name].validate((valid) => {
        if (valid) {
          homeManage.update(this.ruleForm).then((res) => {
            this.$router.push({path: '/index/home-manage/bay-window'})
          })
        } else {
          return false
        }
