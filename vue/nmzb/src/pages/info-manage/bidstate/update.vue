  ...
  <div id="rotate-add" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>编辑招标声明</el-breadcrumb-item>
      </el-breadcrumb>
    ...
    <div class="contentbigbox">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="公告内容:" prop="content" class="form-ueditor">
...
export default {
  ...
  methods: {
    detail () {
      infoManageBidState.detail(this.$route.query.objectId).then((res) => {
        this.$refs.content.setContent(res.data.bidInvitation.content)
        this.ruleForm = res.data.bidInvitation
        this.ruleForm.sourceOfFunds = res.data.bidInvitation.sourceOfFunds.toString()
      })
    },
    submitForm (name) {
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          infoManageBidState.update(this.ruleForm).then((res) => {
