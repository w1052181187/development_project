  ...
  <div id="bidannoupdate" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>{{tenderBulletin.noticeNature !== '4' ? '修改招标公告' : '修改废标公告' }}</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
        ...
        <el-form :model="tenderBulletin" :rules="rules" ref="tenderBulletins">
          <table class="detailtable">
            ...
            <tr v-if="tenderBulletin.noticeNature !== '4'">
              ...
              <td  colspan="2">
                <el-form-item prop="tenderBulletinExpandsInfo.approvedDepartme">
                  <el-input v-model="tenderBulletin.tenderBulletinExpandsInfo.approvedDepartment" placeholder="请输入招标项目核准部门"></el-input>
                </el-form-item>
              </td>
            </tr>
            <tr style="height: 60px;" v-if="tenderBulletin.noticeNature !== '4'">
              ...
              <td colspan="2">
                <el-form-item prop="approveFileInfo">
                  <upload-file @uploadSuccess="uploadSuccess" @deleteSuccess="deleteSuccess" :fileArrays="tenderBulletin.fileInformations" fileType="1" isImage="0"></upload-file>
                </el-form-item>
              </td>
            </tr>
            <tr>
            ...
            <tr v-if="tenderBulletin.tenderExpandsInfo.tenderOrganizeForm !== 1 && tenderBulletin.noticeNature !== '4'" style="height: 60px;">
              ...
              <td colspan="2">
                <el-form-item prop="agentFileInfo">
                  <upload-file @uploadSuccess="uploadSuccess" @deleteSuccess="deleteSuccess" :fileArrays="tenderBulletin.fileInformations" fileType="2" isImage="0"></upload-file>
                </el-form-item>
              </td>
            </tr>
            <tr  v-if="tenderBulletin.noticeNature !== '4'">
            ...
            <tr v-if="tenderBulletin.noticeNature !== '4'">
              ...
              <td  colspan="2">
                <el-form-item prop="tenderExpandsInfo.versionNum">
            ...
            <tr style="height: 60px;">
              ...
              <td colspan="5">
                <el-form-item prop="otherFileInfo">
                  <upload-file @uploadSuccess="uploadOtherSuccess" @deleteSuccess="deleteSuccess" :fileArrays="tenderBulletin.fileInformations" fileType="9" isImage="0"></upload-file>
                </el-form-item>
              </td>
            </tr>
          </table>
          <el-form-item class="submit-radio">
            <el-button type="primary" @click="submitForm('tenderBulletins', 1)" :loading="isSubmiting">提交</el-button>
            <el-button type="primary" class="save" @click="submitForm('tenderBulletins', 0)" :loading="isSubmiting">保存</el-button>
...
export default {
  ...
  methods: {
      ...
      bidanno.detail(this.$route.query.objectId).then((res) => {
        ...
        this.tenderBulletin.fileInformations.map((item) => {
          if (item.businessType === '1') {
            this.oldApproveFileName = item.fileName
            this.relativeApprovePath = item.relativePath
            this.oldApproveFile = item
    ...
    uploadSuccess (file, fileType) {
      this.tenderBulletin.fileInformations = this.tenderBulletin.fileInformations.filter(item => item.businessType !== fileType)
      this.tenderBulletin.fileInformations.push(file)
    },
    // 上传附件
    ...
    deleteSuccess (fileId) {
      this.tenderBulletin.fileInformations = this.tenderBulletin.fileInformations.filter(item => item.relativePath !== fileId)
    },
    submitForm (name, status) {
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          bidanno.update(this.tenderBulletin).then((res) => {
