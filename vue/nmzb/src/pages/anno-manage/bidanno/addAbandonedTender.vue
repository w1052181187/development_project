            ...
            <tr>
              ...
              <td colspan="2">
                <el-form-item prop="otherFileInfo">
                  <upload-file @uploadSuccess="uploadSuccess" @deleteSuccess="deleteSuccess" :fileArrays="tenderBulletin.fileInformations" fileType="9" isImage="0" fileMaxNum="5" ></upload-file>
                </el-form-item>
              </td>
            </tr>
            <tr>
