  ...
  <div id="bidwinupdate" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>修改中标候选人公示</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
  ...
  methods: {
    ...
    detail () {
      bidwin.detail(this.$route.query.objectId).then((res) => {
        this.disableFlag = !!res.data.record.relatedCode
        console.log('disableFlag', this.disableFlag)
        console.log('relatedCode', res.data.record.relatedCode)
