<template>
  <div id="ckbidannocheck" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>审核招标公告</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
        ...
        <el-form :model="tenderBulletin" ref="tenderBulletins">
          <table class="detailtable">
            ...
            <tr v-if="tenderBulletin.noticeNature !== '4'">
              <td>项目规模：</td>
              <td colspan="2">
                <span :title="tenderBulletin.tenderBulletinExpandsInfo.projectScale">{{tenderBulletin.tenderBulletinExpandsInfo.projectScale}}</span>
              </td>
              <td>招标项目核准部门：</td>
              <td colspan="2">
            ...
            <tr v-if="tenderBulletin.noticeNature !== '4'">
              ...
              <td>招标项目核准文件：</td>
              <td colspan="2">
                <file-download :fileArrays="tenderBulletin.fileInformations" fileType="1"></file-download>
              </td>
            </tr>
            <tr>
              <td>公告名称：</td>
            ...
            <tr v-if="tenderBulletin.tenderExpandsInfo.tenderOrganizeForm !== 1 && tenderBulletin.noticeNature !== '4'">
              ...
              <td>委托代理协议附件：</td>
              <td  colspan="2">
                <file-download :fileArrays="tenderBulletin.fileInformations" fileType="2"></file-download>
              </td>
            </tr>
            <tr v-if="tenderBulletin.noticeNature !== '4'">
              <td>招标文件获取开始时间：</td>
            ...
            <tr v-if="fileObject !== null">
              <td>公告附件：</td>
              <td colspan="5">
                <file-download :fileArrays="tenderBulletin.fileInformations" fileType="9"></file-download>
              </td>
            </tr>
            <tr v-if="showNotice">
              <td>公告内容：</td>
...
export default {
  ...
  methods: {
    ...
    submitForm () {
      ...
      bidanno.approve(this.tenderBulletin).then((res) => {
        this.$router.push({path: '/annoapprove/ckbidanno', query: {status: this.status}})
      })
    }
  },
