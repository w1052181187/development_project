<template>
  <div id="ckbidwin" class="smaincontent">
    <div class="headertitle">
      <!--面包屑-->
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/main' }">首页</el-breadcrumb-item>
        <el-breadcrumb-item>公告审核</el-breadcrumb-item>
        <el-breadcrumb-item>中标候选人公示审核</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    // 审核
    checkBtn (scope) {
      this.$router.push({path: '/annoapprove/ckbidwin/check', query: {objectId: scope.row.object_id, status: this.status}})
    },
    // 查看
    detailBtn (scope) {
      this.$router.push({path: `/annoapprove/ckbidwin/detail/${scope.row.object_id}`, query: {status: this.status}})
    },
    // 分页
