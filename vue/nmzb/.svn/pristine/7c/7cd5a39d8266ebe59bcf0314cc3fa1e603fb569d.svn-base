  ...
  <div id="ckresultannocheck" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/annoapprove/ckresultanno' }">中标公告审核</el-breadcrumb-item>
        <el-breadcrumb-item>审核中标公告</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
...
export default {
  ...
  methods: {
    ...
    submitForm () {
      ...
      resultAnno.approve(this.winBidForm).then((res) => {
        this.$router.push({path: '/annoapprove/ckresultanno', query: {status: this.status}})
      })
    }
  },
