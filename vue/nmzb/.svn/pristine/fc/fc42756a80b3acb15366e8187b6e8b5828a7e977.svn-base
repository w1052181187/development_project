            ...
            <tr>
              ...
              <td  colspan="2">
                <el-form-item prop="bidSectionCode">
                  <el-input  v-model="winBidForm.bidSectionCode" placeholder="请输入标段（包）编号" @focus="handleFocus()" v-bind:disabled="disableFlag"></el-input>
                </el-form-item>
              </td>
  ...
  methods: {
    ...
    detail () {
      resultAnno.detail(this.$route.query.objectId).then((res) => {
        this.disableFlag = !!res.data.winBidBulletin.relatedCode
