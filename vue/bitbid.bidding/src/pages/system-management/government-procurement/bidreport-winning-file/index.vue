  ...
  <div id="projectfileindexbox" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>评标报告及中标候选人备案</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    list () {
      ...
      pushData.pingBiao(url).then((res) => {
        this.projecttableData = JSON.parse(res.data.pingBiaoList)
    ...
    detailBtn (scope) {
      console.log(scope)
      this.$router.push({path: `/system-management/government-procurement/bidreport-winning-file/detail/${scope.row.biaoDuanId}`, query: {type: scope.row.transferType}})
    }
  },
  mounted () {
    this.list()
