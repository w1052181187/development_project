  ...
  <div id="projectfileindexbox" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>中标确认函备案</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    list () {
      ...
      pushData.confirmation(url).then((res) => {
        this.projecttableData = JSON.parse(res.data.confirmationList)
    ...
    search () {
      ...
      //   type: 3
      // }
      // pushData.confirmation(searchs).then((res) => {
      //   this.projecttableData = JSON.parse(res.data.confirmationList)
      // })
    },
    // 搜索选择
    ...
    detailBtn (scope) {
      console.log(scope)
      this.$router.push({path: `/system-management/government-procurement/letter-of-acceptance-file/detail/${scope.row.id}`, query: {type: scope.row.transferType}})
    }
  },
  mounted () {
    this.list()
