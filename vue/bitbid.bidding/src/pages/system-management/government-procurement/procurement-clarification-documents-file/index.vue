  ...
  <div id="prefilelist" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>采购澄清修改文件备案</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    list () {
      ...
      pushData.zbwjbcFile(url).then((res) => {
        this.projecttableData = JSON.parse(res.data.zbwjbcFileList)
    ...
    detailBtn (scope, type) {
      this.$router.push({path: `/system-management/government-procurement/procurement-clarification-documents-file/detail-or-check/${type}/${scope.row.id}`})
    }
  },
  mounted () {
    this.list()
