  ...
  <div id="projectdetailbox" class="smaincontent" >
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/system-management/government-procurement/procurement-notice-file' }">采购公告备案</el-breadcrumb-item>
        <el-breadcrumb-item>{{type === "check" ? '审批' : '查看'}}</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <div class="returnboxbig" v-if="type === 'detail'">
        <router-link tag='span' to="/system-management/government-procurement/procurement-notice-file">返回</router-link>
      </div>
    </div>
...
export default {
  ...
  beforeCreate () {
    // document.title = this.type === 'detail' ? '采购公告备案详情' : '采购公告备案审核'
  }
}
</script>
<style lang="less">
