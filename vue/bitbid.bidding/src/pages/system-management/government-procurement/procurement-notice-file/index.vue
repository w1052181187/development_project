  ...
  <div id="procurementproject" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>采购公告备案</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    list () {
      ...
      pushData.annoList(url).then((res) => {
        this.projecttableData = JSON.parse(res.data.annoString)
    ...
    detailBtn (scope, type) {
      this.$router.push({path: `/system-management/government-procurement/procurement-notice-file/detail-or-check/${type}/${scope.row.id}`, query: {type: scope.row.transferType}})
    },
