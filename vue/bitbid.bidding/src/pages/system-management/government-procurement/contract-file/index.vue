        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <div class="statusbigbox" v-if="scope.row.faBuZhuangTai === 2">
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <el-button type="text" size="small" @click="detailBtn(scope, 'check')" v-if="scope.row.faBuZhuangTai === 1">
                审批
              </el-button>
              <!--</div>-->
              <!--<div class="statusbigbox" >-->
...
export default {
  ...
  methods: {
    ...
    list () {
      ...
      pushData.contract(url).then((res) => {
        this.projecttableData = JSON.parse(res.data.contractList)
    ...
    detailBtn (scope, type) {
      this.$router.push({path: `/system-management/government-procurement/contract-file/detail-or-check/${type}/${scope.row.id}`, query: {type: scope.row.transferType}})
    }
  },
  mounted () {
    this.list()
