<template>
  <div id="auctionrecorddetail" class="smaincontent">
    <div class="headertitle">
      <!--面包屑-->
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/system-management' }">首页</el-breadcrumb-item>
        <el-breadcrumb-item>矿权交易备案</el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '/system-management/mineral-rights/auction-bidding' }">拍卖竞价情况查看</el-breadcrumb-item>
        <el-breadcrumb-item>查看竞价记录</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <div class="returnboxbig">
        <router-link tag='span' to="/system-management/mineral-rights/auction-bidding">返回</router-link>
      </div>
    </div>
  ...
  data () {
    return {
      ruleForm: {
        ...
        annoNumber: this.$route.query.annoNumber
      },
      auctiontableData: [],
      // 当前页
      currentPage: 1,
