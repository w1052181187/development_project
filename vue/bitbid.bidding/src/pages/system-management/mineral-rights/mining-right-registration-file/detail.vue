<template>
  <div id="mindetailebox" class="smaincontent">
    <div class="headertitle">
      ...
      <div class="returnboxbig">
        <router-link tag='span' to="/system-management/mineral-rights/mining-right-registration-file">返回</router-link>
      </div>
    </div>
    <div class="contentbigbox detailcontentbigbox">
      <el-form :model="miningAnnoForm" ref="miningAnnoForm" label-width="100px" class="demo-ruleForm">
        ...
        <div class="proinfobox">
          ...
          <!--探矿权-->
          <div class="formmian" v-if="Number(this.$route.query.MineralRights) === 1">
            <el-row>
              <el-col :span="8">
          ...
          <!--探矿权-->
          <!--采矿权-->
          <div class="formmian"  v-if="Number(this.$route.query.MineralRights) === 2">
            <el-row>
              <el-col :span="8">
        ...
        <!--关联项目信息-->
        <div class="proinfobox">
          <span class="title" style="border-left: 3px solid #b94aff">关联项目信息</span>
          <el-table
...
export default {
  ...
  mounted () {
    ...
    sannoProject.queryOne(objectId).then((res) => {
