  ...
  <div id="otherdetailebox" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/system-management/mineral-rights/other-way-mining-file' }">其他方式采矿权出让公示备案</el-breadcrumb-item>
        <el-breadcrumb-item>公示查看</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <div class="returnboxbig">
        <router-link tag='span' to="/system-management/mineral-rights/other-way-mining-file">返回</router-link>
      </div>
    </div>
