  ...
  <div id="subdetailindexbox" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/system-management/mineral-rights/supplementary-notice-file' }">补充公告备案</el-breadcrumb-item>
        <el-breadcrumb-item>补充公告查看</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <div class="returnboxbig">
        <router-link tag='span' to="/system-management/mineral-rights/supplementary-notice-file">返回</router-link>
      </div>
    </div>
...
export default {
  ...
  methods: {
    list () {
      sanno.announcementDetail(this.$route.params.objectId).then((res) => {
