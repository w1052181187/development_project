  ...
  <div id="auctionrecorddetail">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/system-management/mineral-rights/listing-bidding' }">挂牌竞价情况查看</el-breadcrumb-item>
        <el-breadcrumb-item>查看竞价记录</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <div class="returnboxbig">
        <router-link tag='span' to="/system-management/mineral-rights/listing-bidding">返回</router-link>
      </div>
    </div>
