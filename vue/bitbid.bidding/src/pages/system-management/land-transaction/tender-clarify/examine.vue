  ...
  <div id="land_ann_lookdetailbox" class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>招标澄清/修改文件审批</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
import {clarifyFile, sApproveRecord} from '@/api'
export default {
  components: {
    commonFileDownload,
    examineApprove,
  ...
  methods: {
    ...
    approveForm (val) {
      ...
      this.checkResult.approvalType = 13
    ...
    submitForm () {
      ...
      sApproveRecord.save(this.checkResult).then((res) => {
        ...
        clarifyFile.updateStatus(this.sectionForm).then((res) => {
          this.$router.push({path: '/system-management/land-transaction/tender-clarify/index'})
        })
      })
    }
  },
