<template>
  <div id="proexambox" class="maincontent">
...
import {landProject, fileInfo, sApproveRecord} from '@/api'
export default {
  components: {
    commonFileDownload,
    examineApprove
    ...
    submitForm () {
      ...
      sApproveRecord.save(this.checkResult).then((res) => {
        ...
        landProject.update(this.sectionForm).then(res => {
          this.$router.push({path: '/system-management/land-transaction/project/index'})
        })
      })
    },
    detail () {
