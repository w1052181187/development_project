...
export default {
  ...
  methods: {
    ...
    // -----------------------------------------查看----------------------------------------------
    detailBtn (scope) {
      this.$router.push({path: `/system-management/land-transaction/prequalification-file/detail/${scope.row.objectId}`, query: {roledsType: 1, objectId: scope.row.objectId}})
    },
    // -----------------------------------------审批----------------------------------------------
    examineBtn (scope) {
      this.$router.push({path: `/system-management/land-transaction/prequalification-file/examine/${scope.row.objectId}`, query: {roledsType: 1, objectId: scope.row.objectId}})
    },
    // ***************************************************************自己方法**********************************************************************
    // 搜索选择
    selectSeacher (val) {
