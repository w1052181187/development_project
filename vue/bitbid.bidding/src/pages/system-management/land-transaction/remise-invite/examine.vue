  ...
  <div id="addbox" class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>出让邀请书审批</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    approveForm (val) {
      ...
      this.checkResult.approvalType = 2 // 邀请书标示
    ...
    submitForm () {
      ...
      sApproveRecord.save(this.checkResult).then((res) => {
        ...
        landAnno.update(this.sectionForm).then((res) => {
          this.$router.push({path: '/system-management/land-transaction/remise-invite/index'})
        })
      })
    },
    landAnnoInfo () {
