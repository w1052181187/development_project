<template>
  <div id="syslandannlookdetailbox" class="maincontent">
    <div class="headertitle">
      <!--面包屑-->
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/system-management' }">首页</el-breadcrumb-item>
        <el-breadcrumb-item>项目管理</el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '/system-management/land-transaction/supp-announ/index' }">补充公告备案</el-breadcrumb-item>
        <el-breadcrumb-item>补充公告查看</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <div class="returnboxbig">
        <router-link tag='span' to="/system-management/land-transaction/supp-announ/index">返回</router-link>
      </div>
    </div>
      ...
      <el-form :model="sectionForm" label-width="200px" class="demo-ruleForm">
        ...
        <div class="proinfobox">
          ...
          <div class="formmain">
            <el-row>
              <el-col :span="8">
                <el-form-item label="补充公告名称：" prop="annoNumber">
  ...
  methods: {
    landAnnoInfo () {
      landAnno.detail(this.$route.params.objectId).then((res) => {
        ...
        if (res.data.landAnno.approveRecords4) { // 审批记录
          this.recordApprovalTable = res.data.landAnno.approveRecords4
        }
