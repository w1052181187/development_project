<template>
  <div id="systemlandsupplookindex" class="maincontent">
...
export default {
  ...
  methods: {
    ...
    // -----------------------------------------查看----------------------------------------------
    detailBtn (scope) {
      this.$router.push({path: `/system-management/land-transaction/supp-announ/detail/${scope.row.objectId}`, query: {methodOfTransfer: scope.row.type}})
    },
    // -----------------------------------------审批----------------------------------------------
    examineBtn (scope) {
      this.$router.push({path: `/system-management/land-transaction/supp-announ/examine/${scope.row.objectId}`, query: {methodOfTransfer: scope.row.type}})
    },
    // ***************************************************************自己方法**********************************************************************
    // 搜索选择
    selectSeacher (val) {
