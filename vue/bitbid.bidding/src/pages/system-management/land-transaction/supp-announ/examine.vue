<template>
  <div id="systemlandsuppslookdetailbox" class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>补充公告审批</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
    ...
    submitForm () {
      ...
      sApproveRecord.save(this.checkResult).then((res) => {
        ...
        landAnno.update1(this.sectionForm).then((res) => {
          this.$router.push({path: '/system-management/land-transaction/supp-announ/index'})
        })
      })
    },
    // 取消
