  ...
  <div id="land_ann_lookdetailbox" class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>合同审批</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
import {sApproveRecord, contract} from '@/api'
export default {
  components: {
    commonFileDownload,
    examineApprove,
  ...
  methods: {
    ...
    approveForm (val) {
      ...
      this.checkResult.approvalType = 17
    ...
    submitForm () {
      ...
      sApproveRecord.save(this.checkResult).then((res) => {
        this.contractForm.status = this.checkResult.approvrResult
        contract.update(this.contractForm).then((res) => {
          this.$router.push({path: '/system-management/land-transaction/contract/index'})
        })
      })
    }
  },
