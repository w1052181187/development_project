  ...
  <div id="feepayindexbox" class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>挂牌竞价情况备案</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    detailBtn (scope) {
      this.$router.push({path: `/system-management/land-transaction/listed/detail/${scope.row.objectId}`, query: {roledsType: 2}})
    }
  },
  mounted () {
  }
