<template>
  <div class="openfile" title="请上传.gcf格式文件">
    <div :class="btns" id="openbtns">
      <div id="picker"><img src="../../../../static/images/system-quantybill/ico1.png"/> 打开本地文件</div>
    </div>
...
export default {
  ...
  data () {
    return {
      ...
      cdnUrl: `${loadUrl}comptend/project/localFile/process/open`,
      host: '查看上传文件地址',
      cdnParams: {
  ...
  methods: {
    handleSuccess (file, res) {
      ...
      this.$router.push({path: `/system-quantybill/process`, query: {type: res.type, projectId: res.projectId}})
    },
    beforeUpload (file) {
