    ...
    <div id="bidroom">
      <div class="headertitle">
        ...
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item :to="{ path: '/mr/transferor/auction/check-auction-bids?roledsType=2' }">查看拍卖竞价情况</el-breadcrumb-item>
      ...
      <div class="contentbigbox">
        ...
        <template>
          <!--主要内容 iframe-->
          <iframe id="if" src="../../../../../../static/mineral-bidroom/html/assignee/bidroom.html" style="width: 100%; height: 1100px;"></iframe>
          <!--主要内容 iframe-->
        </template>
      </div>
    </div>
...
export default {
  ...
  created () {
    let auctionRoom = {}
    auctionRoom.roomId = this.$route.query.roomId
