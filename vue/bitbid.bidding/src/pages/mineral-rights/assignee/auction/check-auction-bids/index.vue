  ...
  <div id="bidrecord">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>查看拍卖竞价记录</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    // 查看
    detailBtn (scope) {
      this.$router.push({path: '/mr/assignee/auction/check-auction-bids/detail', query: {name: scope.row.Selltype, sectionName: scope.row.sectionName, sectionNumber: scope.row.sectionNumber, annoNumber: scope.row.announcement.annoNumber, roomId: scope.row.roomId, roledsType: 2}})
    },
    list () {
    ...
    search () {
      ...
      prProject.queryAuctionList(searchs).then((res) => {
        this.auctiontableData = res.data.sectionPageInfo.list
        this.total = res.data.sectionPageInfo.total
        this.searchIs = true
      })
