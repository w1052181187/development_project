            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="项目名称：" prop="sectionName">
                  <span>{{contractForm.sectionName}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="项目编号：" prop="sectionNumber">
                  <span>{{contractForm.sectionNumber}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="公告名称：" prop="unifiedTransCode">
                  <span>{{contractForm.annoNumber}}</span>
                </el-form-item>
              </el-col>
            </el-row>
          </div>
  ...
  methods: {
    list () {
      contract.queryOne(this.$route.params.objectId).then((res) => {
        ...
        this.contractForm.sectionName = res.data.contractOneInfo.section.sectionName
        this.contractForm.sectionNumber = res.data.contractOneInfo.section.sectionNumber
        this.contractForm.annoNumber = res.data.contractOneInfo.section.announcement.annoNumber
