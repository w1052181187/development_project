  ...
  methods: {
    list () {
      apply.applyDetail(this.$route.params.objectId).then((res) => {
        ...
        b.annoNumber = res.data.Apply.section.announcement.annoNumber === null ? res.data.Apply.section.announcement.suppleAnnoNumber : res.data.Apply.section.announcement.annoNumber
