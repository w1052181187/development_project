<template>
  <div id="downloadsellbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/mr/assignee/transfer-documents/download-sell-file?roledsType=2' }">下载出让文件</el-breadcrumb-item>
...
export default {
  ...
  methods: {
    ...
    detailByAssignee () {
      ...
      // 根据项目id查询出出让文件信息
      // 根据项目id查询出澄清文件信息
      prProject.queryOne(this.$route.query.transDocSectionid).then((res) => {
      ...
      tdocuments.detailByAssignee(this.$route.query.transDocSectionid).then((res) => {
        ...
        if (res.data.transferDocuments !== null) {
