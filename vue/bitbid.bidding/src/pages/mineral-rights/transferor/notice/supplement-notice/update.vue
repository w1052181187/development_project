  ...
  <div id="subupdateindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>补充公告</el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '/mr/transferor/submission/supplement-notice' }">提交补充公告</el-breadcrumb-item>
        <el-breadcrumb-item>编辑补充公告</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
            ...
            <el-row>
              <el-col :span="24" class="area">
                <el-form-item label="公告内容：" prop="content" class="bitianicon">
                  <div class="editor">
                    <editor ref="ueditor" class="ueditor" :editread="editread" :content="ruleForm.content"></editor>
                  </div>
                </el-form-item>
              </el-col>
            </el-row>
  ...
  methods: {
    ...
    list () {
      anno.announcementDetail(this.$route.query.ObjectId).then((res) => {
        ...
        this.ruleForm.isAllowedBidding = res.data.Announcement.isAllowedBidding
