    ...
    <div class="contentbigbox detailcontentbigbox">
      <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <div class="proinfobox" v-if="parseInt(this.$route.query.landUse) === 1">
          ...
          <div class="formmian" v-for="(sectionlist,index) in ruleForm.suppSections" :key="index" >
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <div class="statusbigbox" v-if="scope.row.approvrResult === '0'">
                <span class="statusbox">不通过</span>
              </div>
              <div class="statusbigbox" v-if="scope.row.approvrResult === '1'">
...
export default {
  ...
  methods: {
    list () {
      anno.announcementDetail(this.$route.params.objectId).then((res) => {
        ...
        if (res.data.Announcement.sections.length === 0) {
          res.data.Announcement.refSuppAnnoSections.map((its) => {
            this.ruleForm.suppSections.push(its.section)
          })
        }
        // 三级联动赋值
        res.data.Announcement.suppSections.map((ite) => {
          ite.allAddress = ''
