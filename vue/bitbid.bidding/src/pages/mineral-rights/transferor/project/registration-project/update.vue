<template>
  <div id="updatebox" class="maincontent">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="项目编号" prop="sectionNumber">
                  <el-input v-model="sectionForm.sectionNumber"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="统一交易标识码" prop="unifiedTransCode">
                  <el-input v-model="sectionForm.unifiedTransCode"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item label="投资项目统一代码" prop="investProjectCode">
                  <el-input v-model="sectionForm.investProjectCode"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="出让人名称" prop="transferorName">
                  <el-input v-model="sectionForm.transferorName" ></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-row>
                <el-col :span="24" class="area">
                  <el-form-item label="资源储量情况" prop="resourceReserves">
                    <el-input type="textarea" v-model="sectionForm.resourceReserves"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </div>
...
import {sumType, isvalidFixedPhone} from '@/assets/js/validate'
export default {
  components: {
    commonFileUpload
  },
          ...
          prProject.update(this.sectionForm).then((res) => {
            ...
            if (that.fileArry.length !== 0) {
              fileInfo.deleteFile(this.originalId).then((res) => {
                that.fileArry[0].relatedCode = that.sectionForm.code
  ...
  mounted () {
    prProject.queryOne(this.$route.query.objectId).then((res) => {
      ...
      this.sectionForm.minerals = res.data.sectionOneInfo.minerals
      this.sectionForm.mineName = res.data.sectionOneInfo.mineName
      this.sectionForm.region = Number(res.data.sectionOneInfo.region)
      // 三级联动赋值
      let provinceId = Number(res.data.sectionOneInfo.provinceId)
      let cityId = Number(res.data.sectionOneInfo.cityId)
      let countyId = Number(res.data.sectionOneInfo.countyId)
      this.selectedcityOptions = [provinceId, cityId, countyId]
      if (res.data.sectionOneInfo.fileInformations) {
        this.oldFileName = res.data.sectionOneInfo.fileInformations.fileName
        this.originalId = res.data.sectionOneInfo.fileInformations.objectId
      }
    })
  }
}
