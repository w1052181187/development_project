<template>
  <div id="lookindexbox"  class="maincontent">
...
export default {
  ...
  methods: {
    ...
    // 查看
    lookBtn (scope) {
      this.$router.push({path: `/mr/transferor/business-confirmation/look-results-transaction/detail/${scope.row.objectId}`, query: {roledsType: 1}})
    },
    // 列表显示
    queryList () {
      let url = null
