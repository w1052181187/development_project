...
export default {
  ...
  methods: {
    ...
    // 查看
    detailBtn (scope) {
      this.$router.push({path: '/mr/transferor/project/registration-project/detail', query: {name: scope.row.Selltype, roledsType: 1}})
    },
    // 编辑
    updateBtn (scope) {
      this.$router.push({path: '/mr/transferor/project/registration-project/update', query: {name: scope.row.Selltype, roledsType: 1}})
    }
  },
  mounted () {
    this.list()
