<template>
  <div id="lookotherprospindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>查看{{this.$route.query.name}}公示</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    // 查看
    lookBtn (scope) {
      this.$router.push({path: `/mr/transferor/other-mining-sell/sub-other-prospect/detail/${scope.row.objectId}`, query: {objectId: scope.row.objectId, name: this.$route.query.name, type: this.$route.query.type}})
    }
  },
  watch: {
    $route () {
