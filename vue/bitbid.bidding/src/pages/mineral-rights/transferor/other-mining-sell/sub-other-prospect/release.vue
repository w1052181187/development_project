<template>
  <div id="otherreleasebox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>发布公示</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
    <div class="contentbigbox detailcontentbigbox">
      <el-form :model="otherPublicityForm" :rules="rules" ref="otherPublicityForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item class="submit-radio">
          <el-button type="primary" @click="submitForm('otherPublicityForm')">发布</el-button>
...
export default {
  ...
  methods: {
    ...
    submitForm (otherPublicityForm) {
      ...
      this.otherPublicityForm.status = 4
      this.otherPublicityForm.contents = this.$refs.ueditor.getContent() // 富文本内容获取
