    ...
    <div id="enrolmentindex"  class="maincontent">
      <div class="headertitle">
        ...
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>查看报名情况</el-breadcrumb-item>
        </el-breadcrumb>
        <!--面包屑-->
      </div>
...
export default {
  ...
  methods: {
    ...
    // 查看
    detailBtn (scope) {
      this.$router.push({path: `/mr/transferor/online-registration/look-registration/detail/${scope.row.objectId}`, query: {ObjectId: scope.row.objectId}})
    }
  },
  mounted () {
    this.list()
