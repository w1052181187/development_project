<template>
  <div id="lookclmissionindexbox"  class="maincontent">
...
export default {
  ...
  methods: {
    ...
    // 查看
    lookBtn (scope) {
      this.$router.push({path: `/mr/transferor/transfer-documents/sub-clarify-documents/detail/${scope.row.objectId}`, query: {name: scope.row.Sellmethods, roledsType: 1}})
    },
    // 列表显示
    queryList () {
      let url = null
