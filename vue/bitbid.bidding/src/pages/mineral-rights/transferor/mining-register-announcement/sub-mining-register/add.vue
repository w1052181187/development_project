<template>
  <div id="miningaddbox"  class="maincontent">
        ...
        <div class="proinfobox">
          ...
          <div class="formmain">
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="公告时间：" class="content_notice bitianicon">
                  <el-date-picker
  ...
  data () {
    ...
    return {
      ...
      miningAnnoForm: {
        ...
        cityId: '',
        countyId: '',
        mineralType: parseInt(this.$route.query.mineralSpecies),
        miningType: parseInt(this.$route.query.MineralRights),
        region: 1
      },
      addStatus: 0,
      // 单位
    ...
    submitForm (miningAnnoForm, flag) {
      ...
      this.$refs[miningAnnoForm].validate((valid) => {
        if (valid) {
          ...
          annoProject.save(this.miningAnnoForm).then((res) => {
            this.fileArry[0].relatedCode = res.data.miningAnno.code
            let allFile = null
            if (this.fileOtherArry.length !== 0) {
              this.fileOtherArry[0].relatedCode = res.data.miningAnno.code
            ...
            this.$router.push({name: 'subMiningRegister-list'})
          })
        } else {
          return false
        }
