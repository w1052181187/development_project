  ...
  <div id="tranaddindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/assignee/tender-file/auction-listing/index?roledsType=2&showStatus=false'}">下载出让文件</el-breadcrumb-item>
  ...
  methods: {
    ...
    detailByAssignee () {
      ...
      landProject.detail(this.$route.query.transDocSectionid).then((res) => {
        this.approvaltableData.push(res.data.landInformation)
      })
