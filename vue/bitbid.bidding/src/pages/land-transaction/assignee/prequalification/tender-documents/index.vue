  ...
  <div id="contsubindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>资格预审申请文件澄清</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    // 查看
    clarifyBtn (scope) {
      this.$router.push({path: '/lt/assignee/prequalification/tender-documents/look-question', query: {objectId: scope.row.objectId, roledsType: 2}})
    }
  },
  mounted () {}
}
