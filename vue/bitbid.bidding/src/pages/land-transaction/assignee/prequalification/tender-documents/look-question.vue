  ...
  <div id="contsubindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/assignee/prequalification/tender-documents/index?roledsType=2&showStatus=false'}">资格预审申请文件澄清</el-breadcrumb-item>
        <el-breadcrumb-item>澄清</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    // 澄清
    clarifyBtn (scope) {
      this.$router.push({path: '/lt/assignee/prequalification/tender-documents/clarify', query: {objectId: scope.row.objectId, roledsType: 2}})
    },
    // 查看
    detailBtn (scope) {
      this.$router.push({path: `/lt/assignee/prequalification/tender-documents/detail/${scope.row.objectId}`, query: {roledsType: 2}})
    }
  },
  mounted () {}
}
