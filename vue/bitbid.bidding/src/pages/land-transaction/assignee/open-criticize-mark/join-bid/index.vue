  ...
  <div id="contsubindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>参加开标会</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="openingBtn(scope)">
                网上开标室
              </el-button>
              <el-button type="text" size="small" @click="decryptionBtn(scope)">
                网上解密
              </el-button>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 网上开标室
    openingBtn (scope) {
      this.$router.push({path: '/lt/assignee/open-criticize-mark/join-bid/opening', query: {objectId: scope.row.objectId, isRemote: scope.row.isRemote, roledsType: 2}})
    },
    // 网上解密
    decryptionBtn (scope) {
      this.$router.push({path: '/lt/assignee/open-criticize-mark/join-bid/decryption', query: {objectId: scope.row.objectId, isRemote: scope.row.isRemote, roledsType: 2}})
    }
  },
  mounted () {}
}
