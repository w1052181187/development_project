  ...
  <div id="land_ann_lookdetailbox" class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/assignee/remise-invite/index?roledsType=2' }">查看出让邀请</el-breadcrumb-item>
        <el-breadcrumb-item>确认出让邀请书</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
    <div class="contentbigbox detailcontentbigbox">
      <el-form :model="sectionForm" :rules="rules" ref="sectionForm" label-width="200px" class="demo-ruleForm">
        ...
        <div class="proinfobox">
          ...
          <div class="formmian">
            <el-row>
              <el-col :span="8">
                <el-form-item label="项目名称：">
                  <span>{{sectionForm.landAnnoMation.projectName}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="项目编号：">
                  <span>{{sectionForm.landAnnoMation.projectNumber}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="递交响应文件方法：">
                  <span>{{sectionForm.subFileMethod}}</span>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item label="答疑澄清时间：">
                  <span>{{sectionForm.ansQueStartTime}}</span> 至 <span>{{sectionForm.ansQueEndTime}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="投标有效期（天）：">
                  <span>{{sectionForm.validityOfBids}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="评标办法：">
                  <span v-if="sectionForm.bidEvaMethod === 0">综合评估法</span>
                  <span v-if="sectionForm.bidEvaMethod === 1">经评审最高价中标法</span>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item label="开标时间：">
                  <span>{{sectionForm.bidOpenTime}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="开标地点：">
                  <span>{{sectionForm.bidOpenPlace}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="开标方式：">
                  <span v-if="sectionForm.bidOpeningWay === 0">在线开标</span>
                  <span v-if="sectionForm.bidOpeningWay === 1">线下开标</span>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item label="评标方式：">
                  <span v-if="sectionForm.bidOpenWay === 0">在线评标</span>
                  <span v-if="sectionForm.bidOpenWay === 1">线下评标</span>
                </el-form-item>
              </el-col>
            </el-row>
          </div>
        ...
        <!--地块信息-->
        <div class="proinfobox">
          <span class="title" style="border-left: 3px solid #2d9631">地块信息</span>
          <div class="formmian">
            <el-row>
              <el-col :span="8">
                <el-form-item label="地块编号：">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="受让人邀请确认截止时间：">
                  <span>{{sectionForm.invConEndTime}}</span>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
        ...
        <!--受让人信息-->
        <div class="proinfobox">
          <span class="title" style="border-left: 3px solid #0206fd">受让人信息</span>
          <div class="formmain">
            <el-row>
              <el-col :span="8">
        ...
        <!--确认信息-->
        <div class="proinfobox">
          <span class="title" style="border-left: 3px solid #b94aff">确认信息</span>
          <el-row>
            <el-col>
              <el-form-item label="确认状态：">
                <template>
                  <el-radio v-model="sectionForm.isConfirm" :label="acceptResultsRadio.label" v-for="(acceptResultsRadio,index) in radioAcceptResults" :key="index">{{acceptResultsRadio.name}}</el-radio>
                </template>
              </el-form-item>
            </el-col>
            <el-col>
              <el-form-item label="说明：">
                <el-input type="textarea" v-model="sectionForm.explains"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
        ...
        <div class="submit-radio">
          <el-button type="primary" @click="saveBtn('sectionForm')">保存</el-button>
    ...
    saveBtn (formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.sectionForm.isConfirm = 1
          landProject.update(this.sectionForm).then((res) => {
            this.$router.push({path: '/lt/assignee/remise-invite/index?roledsType=2'})
          })
        } else {
          return false
        }
