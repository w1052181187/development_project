...
export default {
  ...
  methods: {
    ...
    // -----------------------------------------查看----------------------------------------------
    detailBtn (scope) {
      this.$router.push({path: `/lt/assignee/look-transfer-plot/look-massif/detail/${scope.row.objectId}`, query: {roledsType: 2, methodOfTransfer: scope.row.methodOfTransfer}})
    }
  },
  mounted () {}
}
