  ...
  <div id="land_ann_lookdetailbox" class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/assignee/look-transfer-plot/participate/index?roledsType=2' }">我参与的</el-breadcrumb-item>
        <el-breadcrumb-item>地块详情</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <div class="returnboxbig">
        <router-link tag='span' to="/lt/assignee/look-transfer-plot/participate/index?roledsType=2&showStatus=false">返回</router-link>
      </div>
    </div>
