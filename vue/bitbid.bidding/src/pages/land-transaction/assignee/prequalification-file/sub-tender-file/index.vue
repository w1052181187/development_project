  ...
  <div id="land_pro_patchReg" class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>递交资格预审申请文件</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    subBtn (scope) {
      ...
      this.$router.push({path: `/lt/assignee/prequalification-file/sub-tender-file/submit/${scope.row.objectId}`, query: {roledsType: 2, isClarify: scope.row.isClarify}})
    }
  },
  mounted () {}
}
