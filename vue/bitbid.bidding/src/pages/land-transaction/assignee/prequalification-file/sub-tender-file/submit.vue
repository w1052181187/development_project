  ...
  <div id="sub_tender_file"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/assignee/prequalification-file/sub-tender-file/index?roledsType=2&showStatus=false'}">递交资格预审申请文件</el-breadcrumb-item>
    ...
    <div class="contentbigbox detailcontentbigbox">
      <el-form :model="refundedSecurityForm" :rules="rules" ref="refundedSecurityForm" label-width="150px" class="demo-ruleForm">
        ...
        <!--投标文件-->
        <div class="proinfobox">
          <span class="title" style="border-left: 3px solid #2d9631">资格预审申请文件</span>
          <div class="formmian">
            <div class="steps_box">
              <div class="steps_title">第一步：上传资格预审申请文件</div>
            ...
            <div class="steps_box">
              <div class="steps_title">第二步：确认上传资格预审申请文件，并签名<span style="color: #ff0000;font-size: 14px">（在截标时间前完成此步，逾期视为网上投标无效）</span></div>
              <div class="steps_file">
                <span class="steps_file_title">
                  <span style="color: red">*</span>
                  <span>签名确认：</span>
