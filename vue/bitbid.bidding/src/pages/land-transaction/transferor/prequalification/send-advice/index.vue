  ...
  <div id="issuemissionindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>发出资格预审结果通知书</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <el-button type="text" size="small" @click="sendBtn(scope)">
                发出审查结果
              </el-button>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    sendBtn (scope) {
      this.$router.push({path: '/lt/transferor/prequalification/send-advice/send-review-result', query: {roledsType: 1, objectId: scope.row.objectId}})
    },
    detailBtn (scope) {
      this.$router.push({path: `/lt/transferor/prequalification/send-advice/detail/${scope.row.objectId}`, query: {roledsType: 1}})
    }
  },
  mounted () {
  }
