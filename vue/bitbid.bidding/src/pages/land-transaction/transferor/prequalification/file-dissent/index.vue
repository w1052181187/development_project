  ...
  <div id="issuemissionindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>资格预审申请文件异议</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="dissentBtn(scope)">
                异议
              </el-button>
            </template>
          </el-table-column>
...
export default {
      ...
      projecttableData: [
        {
          ...
          plotsLabeled: '6091p',
          openingTime: '2019-02-29 15:23:45',
          objectId: 1
        },
        {
          sectionNumber: '皖探转让公示〔2018〕3号',
        ...
        },
        {
          ...
          annoNumber: '关于安徽省铜陵市盛冲金多金属矿勘探探',
          plotsLabeled: '6091p',
          openingTime: '2018-05-29 15:23:45',
          objectId: 3
        }
      ]
    }
  ...
  methods: {
    ...
    dissentBtn (scope) {
      this.$router.push({path: '/lt/transferor/prequalification/file-dissent/apply-dissent', query: {roledsType: 1, objectId: scope.row.objectId}})
    }
  },
  mounted () {
  }
