  ...
  <div id="issuemissionindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>查看资格预审申请文件澄清</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    detailBtn (scope) {
      this.$router.push({path: '/lt/transferor/prequalification/pre-clarify/dissent', query: {roledsType: 1, objectId: scope.row.objectId}})
    }
  },
  mounted () {
  }
