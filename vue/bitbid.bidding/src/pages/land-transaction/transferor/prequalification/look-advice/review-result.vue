  ...
  <div id="issuemissionindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/transferor/prequalification/look-advice/index?roledsType=1&showStatus=false' }">查看资格预审结果通知书</el-breadcrumb-item>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-checkbox v-model="scope.row.isChecked" disabled></el-checkbox>
            </template>
          </el-table-column>
        </el-table>
        <!--主要内容 table-->
    ...
    list () {
      ...
      if (this.seacherInput !== '') { // 当搜索内容不为空时执行
        if (this.seacherName === '公告名称') {
          url.annoNumber = this.seacherInput
