  ...
  <div id="issuemissionindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>查看评标报告</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    detailBtn (scope) {
      this.$router.push({path: `/lt/transferor/open-criticize-mark/look-report/detail/${scope.row.objectId}`, query: {roledsType: 1}})
    }
  },
  mounted () {
  }
