  ...
  <div id="issuemissionindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>提交评标报告及中标候选人</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <div class="statusbigbox" v-if="scope.row.submitTime === '' || scope.row.submitTime === null">
                <el-button type="text" size="small" @click="subMitBtn(scope)">
                  提交报告
                </el-button>
              </div>
...
export default {
    ...
    return {
      ...
      projecttableData: [
        ...
        },
        {
          sectionNumber: '皖探转让公示〔2018〕3号',
          annoNumber: '关于安徽省铜陵市盛冲金多金属矿勘探探',
          submitTime: '2018-05-29 15:23:45'
        },
        {
          sectionNumber: '皖探转让公示〔2018〕3号',
          annoNumber: '关于安徽省铜陵市盛冲金多金属矿勘探探',
  ...
  methods: {
    ...
    subMitBtn (scope) {
      this.$router.push({path: '/lt/transferor/open-criticize-mark/bid-report/add', query: {roledsType: 1, objectId: scope.row.objectId}})
    },
    detailBtn (scope) {
      this.$router.push({path: `/lt/transferor/open-criticize-mark/bid-report/detail/${scope.row.objectId}`, query: {roledsType: 1}})
    }
  },
  mounted () {
  }
