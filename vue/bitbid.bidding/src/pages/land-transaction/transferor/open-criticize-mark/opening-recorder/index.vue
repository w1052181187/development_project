  ...
  <div id="issuemissionindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>提交开标记录表</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <div class="statusbigbox" v-if="scope.row.releaseStatus === 0">
...
export default {
  ...
  methods: {
    ...
    addBtn (scope) {
      this.$router.push({path: '/lt/transferor/open-criticize-mark/opening-recorder/select-plot', query: {roledsType: 1}})
    },
    updateBtn (scope) {
      this.$router.push({path: '/lt/transferor/open-criticize-mark/opening-recorder/update', query: {roledsType: 1, objectId: scope.row.objectId}})
    },
    detailBtn (scope) {
      this.$router.push({path: `/lt/transferor/open-criticize-mark/opening-recorder/detail/${scope.row.objectId}`, query: {roledsType: 1}})
    }
  },
  mounted () {
  }
