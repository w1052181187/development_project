      ...
      <el-form :model="ruleForm" ref="ruleForm" label-width="140px" class="demo-ruleForm">
        ...
        <div class="proinfobox">
          ...
          <el-row>
            ...
            <el-col :span="12" class="filebigbox">
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <div class="statusbigbox" v-if="scope.row.landAnnoMation.annoType === 3">
        ...
        <el-form-item class="submit-radio">
          <el-button type="primary" @click="submitForm('ruleForm')" :loading="isSubmited">发布</el-button>
