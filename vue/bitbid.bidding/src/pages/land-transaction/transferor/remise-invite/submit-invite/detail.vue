  ...
  <div id="addbox" class="maincontent">
    <div class="headertitle">
      ...
      <div class="returnboxbig">
        <router-link tag='span' to="/lt/transferor/remise-invite/submit-invite?roledsType=1&showStatus=false">返回</router-link>
      </div>
    </div>
    <div class="contentbigbox detailcontentbigbox">
      <el-form :model="sectionForm" label-width="200px" class="demo-ruleForm">
        ...
        <div class="proinfobox">
          ...
          <div class="formmian">
            <div v-for="(info,index) in sectionForm.landInformations" :key="index">
              <el-row>
