...
export default {
  ...
  methods: {
    ...
    // ***************************************************************自己方法**********************************************************************
    acceptBtn (scope) {
      this.$router.push({path: '/lt/transferor/tender-file/look-dissent/accept', query: {objectId: scope.row.objectId, roledsType: 1}})
    },
    detailBtn (scope) {
      this.$router.push({path: `/lt/transferor/tender-file/look-dissent/detail/${scope.row.objectId}`, query: {roledsType: 1}})
    }
  },
  mounted () {
    this.list()
