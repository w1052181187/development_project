        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <div class="statusbigbox" v-if="scope.row.status === 5">
...
export default {
  ...
  methods: {
    ...
    detailBtn (scope) {
      this.$router.push({path: `/lt/transferor/tender-file/look-clarify-file/detail/${scope.row.objectId}`, query: {roledsType: 1}})
    },
    // 展开隐藏信息
    btnOpen (event) {
