...
export default {
  ...
  methods: {
    ...
    addBtn () {
      this.$router.push({path: '/lt/transferor/tender-file/sub-clarify-file/select-announ', query: {roledsType: 1}})
    },
    updateBtn (scope) {
      this.$router.push({path: '/lt/transferor/tender-file/sub-clarify-file/update', query: {roledsType: 1, objectId: scope.row.objectId, annoId: scope.row.annoId}})
    },
    detailBtn (scope) {
      this.$router.push({path: `/lt/transferor/tender-file/sub-clarify-file/detail/${scope.row.objectId}`, query: {roledsType: 1}})
    },
    releaseBtn (scope) {
      this.$router.push({path: `/lt/transferor/tender-file/sub-clarify-file/release/${scope.row.objectId}`, query: {roledsType: 1}})
    },
    deleteBtn (scope) {
