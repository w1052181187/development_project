  ...
  <div id="refundassmarignrefundbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/transferor/after-business/margin-return?roledsType=1' }">申请保证金退回</el-breadcrumb-item>
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="退费方式：" prop="contacts">
                  ...
                  <span v-if="rpayMethod === 2">其他</span>
  ...
  methods: {
    ...
    list () {
      apply.applyDetail(this.$route.query.objectId).then((res) => {
        this.payMethod = Number(res.data.Apply.payMethod)
        this.projectName = res.data.Apply.landInformation.landAnnoMation.projectName
        this.projectNumber = res.data.Apply.landInformation.landAnnoMation.projectNumber
        this.sectionNumber = res.data.Apply.landInformation.sectionNumber
        this.annoNumber = res.data.Apply.landInformation.landAnnoMation.annoNumber
        this.bidBond = res.data.Apply.landInformation.bidBond
      })
    },
    // 提交
    submitForm (refundedSecurityForm) {
      ...
      this.refundedSecurityForm.type = 2
      this.$refs[refundedSecurityForm].validate((valid) => {
        if (valid) {
          refundedSecurity.save(this.refundedSecurityForm).then((res) => {
            ...
            this.$router.push({path: '/lt/transferor/after-business/margin-return?roledsType=1'})
          })
        } else {
          return false
        }
