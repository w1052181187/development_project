  ...
  <div id="addbox" class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/transferor/project/look-massif?roledsType=1&showStatus=false' }">地块登记</el-breadcrumb-item>
        <el-breadcrumb-item>查看地块</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <div class="returnboxbig">
        <router-link tag='span' to="/lt/transferor/project/look-massif?roledsType=1&showStatus=false">返回</router-link>
      </div>
    </div>
  ...
  methods: {
    detail () {
      landProject.detail(this.$route.params.objectId).then(res => {
        ...
        this.selectedcityOptions.push(res.data.landInformation.provinceId)
        this.selectedcityOptions.push(res.data.landInformation.cityId)
        this.selectedcityOptions.push(res.data.landInformation.countyId)
      })
    }
  },
  mounted () {
