  ...
  <div id="marginappaddbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>查看受理</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
            ...
            <el-row>
              <el-col>
                <el-form-item label="是否受理：">
                  <span v-if="refundedSecurityForm.isAccept === 0">否</span>
                  <span v-if="refundedSecurityForm.isAccept === 1">是</span>
                </el-form-item>
              </el-col>
              <el-col>
                <el-form-item label="受理意见：" prop="approvrOpinion">
                  <span>{{refundedSecurityForm.approvrOpinion}}</span>
                </el-form-item>
              </el-col>
            </el-row>
          </el-row>
