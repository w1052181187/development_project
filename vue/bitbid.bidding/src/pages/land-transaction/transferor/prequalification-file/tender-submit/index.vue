  ...
  <div id="issuemissionindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>查看申请文件递交情况</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    detailBtn (scope) {
      this.$router.push({path: `/lt/transferor/prequalification-file/tender-submit/detail/${scope.row.objectId}`, query: {roledsType: 1}})
    }
  },
  mounted () {
  }
