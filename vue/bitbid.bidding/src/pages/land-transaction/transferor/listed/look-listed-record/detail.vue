  ...
  <div id="auctionrecorddetail">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/transferor/listed/look-listed-record?roledsType=1&showStatus=false' }">查看挂牌竞价情况</el-breadcrumb-item>
      ...
      <template>
        ...
        <el-form :model="ruleForm"  label-width="100px" class="demo-ruleForm">
          ...
          <div class="proinfobox">
            ...
            <div class="bidd_type_box">
              <div class="bidd_type_sonbox" v-for="(item,index) in items" :key="index" :class="{active:isTrue==index}" @click="isTrue=index">{{item.name}}</div>
            </div>
            <el-table
...
export default {
  data () {
    return {
      ruleForm: {
        projectName: '关于安徽省铜陵市盛冲金多',
        projectNumber: '关于安徽省铜陵市盛冲金多',
        annoNumber: '关于安徽省铜陵市盛冲金多',
        sectionNumber: '关于安徽省铜陵市盛冲金多'
      },
      items: [ // 记录切换
        {name: '限时竞价记录'},
        {name: '挂牌竞价记录'}
