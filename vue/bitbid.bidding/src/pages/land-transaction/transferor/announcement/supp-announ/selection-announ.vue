...
export default {
  ...
  methods: {
    ...
    // ----------------------------------------------------添加--------------------------------------
    addBtn (scope) {
      this.$router.push({path: '/lt/transferor/announcement/supp-announ/add', query: {methodOfTransfer: scope.row.type, roledsType: 1, showStatus: false, objectId: scope.row.objectId}})
    },
    // ***************************************************************自己方法**********************************************************************
    // 搜索选择
    selectSeacher (val) {
