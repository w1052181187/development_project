<template>
  <div id="land_ann_releasebdetailbox" class="maincontent">
    <div class="headertitle">
      <!--面包屑-->
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/lt/index?roledsType=1&showStatus=false' }">首页</el-breadcrumb-item>
        <el-breadcrumb-item>项目管理</el-breadcrumb-item>
        <el-breadcrumb-item :to="{ path: '/lt/transferor/announcement/supp-announ?roledsType=1&showStatus=false' }">提交补充公告</el-breadcrumb-item>
        <el-breadcrumb-item>发布出让公告</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <div class="returnboxbig">
        <router-link tag='span' to="/lt/transferor/announcement/supp-announ?roledsType=1&showStatus=false">返回</router-link>
      </div>
    </div>
    <div class="contentbigbox detailcontentbigbox">
      <el-form :model="sectionForm" label-width="200px" class="demo-ruleForm">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="补充公告名称：" prop="suppleAnnoNumber">
                  <span>{{sectionForm.suppleAnnoNumber}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="8">
        ...
        <el-form-item class="submit-radio">
          <el-button type="primary" @click="releaseBtn('sectionForm', 4)" :loading="subStatus">发布</el-button>
...
export default {
  ...
  methods: {
    ...
    releaseBtn (sectionForm, flag) {
      ...
      this.subStatus = true
      landAnno.sendAnno(this.sectionForm.objectId).then((res) => {
