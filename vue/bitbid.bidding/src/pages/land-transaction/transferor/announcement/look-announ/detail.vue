  ...
  <div id="land_ann_lookdetailbox" class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/transferor/announcement/look-announ?roledsType=1' }">查看出让公告</el-breadcrumb-item>
        <el-breadcrumb-item>查看出让公告</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <div class="returnboxbig">
        <router-link tag='span' to="/lt/transferor/announcement/look-announ?roledsType=1&showStatus=false">返回</router-link>
      </div>
    </div>
