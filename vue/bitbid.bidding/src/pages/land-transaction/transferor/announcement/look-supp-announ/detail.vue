  ...
  <div id="land_ann_subdetailbox" class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/transferor/announcement/look-supp-announ?roledsType=1' }">查看补充公告</el-breadcrumb-item>
        <el-breadcrumb-item>查看</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <div class="returnboxbig">
        <router-link tag='span' to="/lt/transferor/announcement/look-supp-announ?roledsType=1&showStatus=false">返回</router-link>
      </div>
    </div>
