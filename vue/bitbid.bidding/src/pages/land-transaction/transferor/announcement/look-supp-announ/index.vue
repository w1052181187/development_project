<template>
  <div id="land_pro_suppIndex" class="maincontent">
...
export default {
  ...
  methods: {
    ...
    // -----------------------------------------查看----------------------------------------------
    detailBtn (scope) {
      this.$router.push({path: `/lt/transferor/announcement/look-supp-announ/detail/${scope.row.objectId}`, query: {roledsType: 1, showStatus: false, methodOfTransfer: scope.row.type}})
    },
    // ***************************************************************自己方法**********************************************************************
    // 搜索选择
    selectSeacher (val) {
