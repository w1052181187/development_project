  ...
  <div id="land_ann_releasebdetailbox" class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/transferor/announcement/sub-announ?roledsType=1' }">提交出让公告</el-breadcrumb-item>
        <el-breadcrumb-item>发布出让公告</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <div class="returnboxbig">
        <router-link tag='span' to="/lt/transferor/announcement/sub-announ?roledsType=1&showStatus=false">返回</router-link>
      </div>
    </div>
