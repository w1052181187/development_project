            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="公告类型：" prop="contacts">
                  <span v-if="type === 1">拍卖出让公告</span>
                  <span v-if="type === 2">挂牌出让公告</span>
                  <span v-if="type === 3">资格后审出让公告</span>
                  <span v-if="type === 4">资格预审出让公告</span>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
...
export default {
  ...
  data () {
    ...
    return {
      ...
      fileArry: [],
      oldFileName: '',
      type: this.$route.query.methodOfTransfer
    }
  },
  methods: {
    // 相关地块信息
    ...
    submitForm (sectionForm, flag) {
      ...
      this.sectionForm.type = this.type
      this.sectionForm.annoType = 1
      this.sectionForm.isSupplement = 0
