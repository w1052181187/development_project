  ...
  <div id="enrolmentindex"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>报名受理</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
...
export default {
  ...
  methods: {
    ...
    // 查看
    detailBtn (scope) {
      this.$router.push({path: `/lt/transferor/online-registration/look-registration/detail/${scope.row.objectId}`, query: {roledsType: 1, showStatus: false}})
    }
  },
  mounted () {
    this.list()
