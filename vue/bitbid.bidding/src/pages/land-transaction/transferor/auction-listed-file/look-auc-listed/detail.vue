  ...
  <div id="tranaddindexbox"  class="maincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item :to="{ path: '/lt/transferor/auction-listed-file/look-auc-listed?roledsType=1&showStatus=false' }">查看出让文件</el-breadcrumb-item>
    ...
    querySectionList () {
      ...
      tdocuments.selectRelation(url).then((res) => {
        ...
        tdocuments.detail(this.$route.params.objectId).then((res) => {
          ...
          if (res.data.transferDocuments.fileInformation) {
            this.fileObjecit = res.data.transferDocuments.fileInformation
          }
        })
      })
    },
