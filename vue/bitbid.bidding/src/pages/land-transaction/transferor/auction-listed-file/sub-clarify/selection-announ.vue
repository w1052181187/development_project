...
export default {
  ...
  methods: {
    ...
    // ----------------------------------------------------添加--------------------------------------
    addBtn (scope) {
      this.$router.push({path: '/lt/transferor/auction-listed-file/sub-clarify/add', query: {objectId: scope.row.objectId, roledsType: 1, showStatus: false}})
    },
    // ***************************************************************自己方法**********************************************************************
    // 搜索选择
    selectSeacher (val) {
