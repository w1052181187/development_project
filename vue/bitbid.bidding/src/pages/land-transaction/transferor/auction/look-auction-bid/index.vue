      ...
      <template>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button type="text" size="small" v-if="scope.row.pricestatus === 0">
                进入竞价室
              </el-button>
              <el-button type="text" size="small" v-if="scope.row.pricestatus === 1">
                进入竞价室
              </el-button>
...
export default {
  ...
  methods: {
    ...
    detailBtn (scope) {
      this.$router.push({path: `/lt/transferor/auction/look-auction-bid/detail/${scope.row.objectId}`, query: {roledsType: 1}})
    }
  },
  mounted () {
  }
