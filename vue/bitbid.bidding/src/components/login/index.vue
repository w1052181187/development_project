      ...
      <div class="logobigbox">
        <div class="logobox">
          <div class="logoboximg">
            <img src="../../../static/images/bibi.png" alt="">
          </div>
        </div>
      </div>
          ...
          <div class="login_intbox">
            ...
            <div class="function_bigbox">
              <div class="function_box loginleft">
                <a href="https://www.bibenet.com/protalUser/toRegist.htm" target="_blank">立即注册</a>
              </div>
              <div class="function_box loginright">
                <a href="https://www.bibenet.com/protalUser/toForgetPwdStep1.htm" target="_blank">找回密码</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  created () {
    if (this.$route.query.id !== undefined) {
      this.$store.dispatch('LoginBitbid', this.$route.query).then(userType => {
        this.$router.push(userType === 1 ? {path: '/admin'} : {path: '/index'})
      })
    }
  },
  methods: {
