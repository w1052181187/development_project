  ...
  <div>
    <div id="zyfl" class="content_bigbox">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
        ...
        <el-breadcrumb-item class="active_bread">资源分类设置</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button type="text" size="small" @click="seeNext(scope)" v-if="$store.getters.permissions.includes('/owner-set/detail')">
              详情
            </el-button>
          </template>
        </el-table-column>
...
export default{
  ...
  methods: {
    getData () {
      this.axios.get(`modules?pageNo=${this.dataIndex - 1}&pageSize=${this.pageSize}&isDelete=${0}`).then((res) => {
