  ...
  <div>
    <div id="addItembid" class="content_bigbox">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
        ...
        <el-breadcrumb-item v-if="this.$route.query.bitbidObjectId === null" :to="{path:'/projectpayments/manage/bondlist',query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds,  costTypes: this.$route.query.costTypes, expenseId: this.$route.query.expenseId, expensesType: this.$route.query.expensesType}}">
          {{this.$route.query.name}}
        </el-breadcrumb-item>
        <el-breadcrumb-item v-else :to="{path:'/projectpayments/manage/bondlistonline',query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, bitbidObjectId: this.$route.query.bitbidObjectId,  costTypes: this.$route.query.costTypes, expenseId: this.$route.query.expenseId, expensesType: this.$route.query.expensesType}}">
          {{this.$route.query.name}}
        </el-breadcrumb-item>
      ...
      <el-row style="margin-top:48px">
        <el-form :model="ruleForm" label-width="160px">
          ...
          <el-col :span="24" v-if="Number(this.$route.query.paymentProjress !== 0)">
            <el-form-item label="退还金额(元)：" prop="surrenderValue" class="bitianicon">
              <el-input v-model="ruleForm.surrenderValue" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24" v-if="Number(this.$route.query.paymentProjress !== 0)">
            <el-form-item label="退还方式：" prop="surrenderType" class="bitianicon">
              <el-select class="el-selectbox" v-model="ruleForm.surrenderType" placeholder="请选择" disabled>
                <el-option
                  v-for="item in Paymodefrom"
                  :key="item.value"
                  :label="item.label"
