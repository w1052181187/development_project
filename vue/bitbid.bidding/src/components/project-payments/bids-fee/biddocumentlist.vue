...
export default{
  ...
  methods: {
    ...
    lookBtn (scope) {
      this.$router.push({path: `/projectpayments/manage/biddocumentlist/detail/${scope.row.objectId}`, query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, costTypes: this.$route.query.costTypes, objectIds: scope.row.objectId, expenseId: this.$route.query.expenseId, incomeStatus: this.$route.query.incomeStatus, expensesType: this.$route.query.expensesType}})
    },
    // 删除
    deleteObject (scope) {
