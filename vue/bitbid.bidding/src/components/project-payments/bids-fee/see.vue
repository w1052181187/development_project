  ...
  <div>
    <div id="addItembid" class="content_bigbox">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
        ...
        <el-breadcrumb-item v-if="this.$route.query.bitbidObjectId === null" :to="{path:'/projectpayments/manage/biddocumentlist',query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, costTypes: this.$route.query.costTypes, expenseId: this.$route.query.expenseId,  incomeStatus: this.$route.query.incomeStatus, expensesType: this.$route.query.expensesType}}">
          {{this.$route.query.name}}
        </el-breadcrumb-item>
        <el-breadcrumb-item v-else :to="{path:'/projectpayments/manage/biddocumentlistonline',query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, bitbidObjectId: this.$route.query.bitbidObjectId, costTypes: this.$route.query.costTypes, expenseId: this.$route.query.expenseId,  incomeStatus: this.$route.query.incomeStatus, expensesType: this.$route.query.expensesType}}">
          {{this.$route.query.name}}
        </el-breadcrumb-item>
        <el-breadcrumb-item class="active_bread">查看收费</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <!-- form表单 -->
      <el-row style="margin-top:48px">
        <el-form :model="ruleForm" label-width="160px">
          ...
          <el-col :span="24" v-else>
            <el-form-item label="缴费单位：" prop="paymentUnitName" class="bitianicon">
              <el-input class="el-inputbox" v-model="ruleForm.paymentUnitName" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="应缴金额(元)：" prop="shouldPayment" class="bitianicon">
              <el-input v-model="ruleForm.shouldPayment" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="缴纳金额(元)：" prop="paymentAmount" class="bitianicon">
              <el-input v-model="ruleForm.paymentAmount" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="缴费方式：" prop="paymentType" class="bitianicon">
          ...
          <el-col :span="24">
            <el-form-item label="标书类型：" prop="tenderType" v-if="this.$route.query.name === '标书费'">
              <el-select class="el-selectbox" v-model="ruleForm.tenderType" placeholder="请选择" v-if="tendertypeStayus" disabled>
                <el-option
              ...
              <el-select class="el-selectbox" v-model="ruleForm.tenderType" placeholder="请选择" v-else disabled>
                <el-option
  ...
  methods: {
    ...
    editList () {
      this.axios.get(`charge/${this.$route.query.objectIds}?_t=${new Date().getTime()}`).then((res) => {
        ...
        if (this.ruleForm.tenderType !== null || this.ruleForm.tenderType !== undefined || this.ruleForm.tenderType !== '') {
          if (this.ruleForm.tenderType === 0) {
