  ...
  <div>
    <div id="addItembid" class="content_bigbox">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb_box">
        ...
        <el-breadcrumb-item :to="{path:'/projectpayments/manage/other-expenditure',query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, costTypes:  this.$route.query.costTypes, expenseId: this.$route.query.expenseId, expensesType: this.$route.query.expensesType}}">
          {{this.$route.query.name}}
        </el-breadcrumb-item>
        <el-breadcrumb-item class="active_bread">新增支出</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
      <!-- form表单 -->
      <el-row style="margin-top:48px">
        <el-form :model="ruleForm"  ref="ruleForm" :rules="rules"  label-width="160px">
          <el-col :span="24">
            <el-form-item label="支出项目：" prop="paymentUnitName">
              <el-input class="el-inputbox" v-model="ruleForm.paymentUnitName"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="金额(元)：" prop="surrenderValue">
              <el-input v-model="ruleForm.surrenderValue"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="支出方式：" prop="paymentType">
          ...
          <el-col :span="24">
            <el-form-item label="支出时间：" prop="paymentTime">
          ...
          if (valid) {
            ...
            if (this.ruleForm.paymentUnitName === '') {
              ...
              this.axios.post('charge', this.ruleForm).then((res) => {
                this.$router.push({path: '/projectpayments/manage/other-expenditure', query: {name: this.$route.query.name, incExpenseIds: this.$route.query.incExpenseIds, costTypes: this.$route.query.costTypes, expenseId: this.$route.query.expenseId, expensesType: this.$route.query.expensesType}})
              })
            }
          } else {
            return false
