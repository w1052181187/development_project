    ...
    <div class="homepagecontent">
      ...
      <div class="homepageconright">
        ...
        <el-breadcrumb class="breadcrumbbox" separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item :to="{ path: '/subject', query: {subjectForm: this.$route.query.SelectFrom, flangshow: true}}">主体类型</el-breadcrumb-item>
            ...
            <el-row type="flex" class="row-bg">
              <el-form :model="inForm" ref="inForm" :rules="rules" class="demo-ruleForm">
                <el-collapse-item title="基本信息" name="1" class="contitlebox">
                  ...
                  <el-row>
                    <el-col :span="12">
                      <el-form-item class="bitianicon" label="注册地址：" prop="privinceId" :label-width="formLabelWidth">
                        <el-cascader class=""
                                     expand-trigger="hover"
                ...
                <el-collapse-item title="扩展信息" name="3" class="contitlebox">
                  ...
                  <div style="width: 100%;display:flow-root" v-if="inForm.enterpriseExpand.isDutyLandTax === 0">
                    ...
                    <el-col :span="12" v-bind:class="{'bitianicon' : inForm.enterpriseExpand.isDutyLandTax === 0}">
                  ...
                  <div style="width: 100%;display:flow-root" v-if="inForm.enterpriseExpand.isDutyLandTax === 1">
                    ...
                    <el-col :span="12" v-bind:class="{'bitianicon' : inForm.enterpriseExpand.isDutyLandTax === 1}">
...
export default {
  ...
  methods: {
    // 读取企业信息
    enterpriseData () {
      enterprise.enterpriseList(this.$store.getters.authUser.userId).then(item => {
    ...
    AuthenticationBtn (formName) {
      this.$confirm('确认进行认证吗?', '提示', {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.inForm.personalInfo.userId = this.$store.getters.authUser.userId
            this.inForm.enterpriseExpand.userId = this.$store.getters.authUser.userId
            this.inForm.enterpriseId = this.$store.getters.authUser.enterpriseId
            this.inForm.enterpriseExpand.enterpriseId = this.$store.getters.authUser.enterpriseId
            this.inForm.personalInfo.enterpriseId = this.$store.getters.authUser.enterpriseId
            ...
            enterprise.save(this.inForm).then(item => {
    ...
    cancelBtn (formName) {
      this.$confirm('确认进行上一步操作吗?', '提示', {
        ...
        this.$router.push({path: '/subject', query: {subjectForm: this.$route.query.SelectFrom, flangshow: true}})
      }).catch(() => {
        return false
      })
    },
