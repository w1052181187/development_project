...
export default {
  ...
  data () {
    return {
      ...
      // 接收文件类型
      accept: {
        title: 'Images,zip,rar,sgtb,zgsq,zgys,sgzb,doc,docx,pdf,txt,xlsx',
        extensions: 'jpg,jpeg,png,zip,rar,sgtb,zgsq,zgys,sgzb,doc,docx,pdf,txt,xlsx',
        mimeTypes: 'image/jpg,image/jpeg,image/png,zip,rar,sgtb,zgsq,zgys,sgzb,doc,docx,pdf,txt,xlsx'
      },
  ...
  props: ['fileType', 'oldFileName', 'type'],
  methods: {
