          ...
          <el-form :model="form" :rules="rules" ref="form" status-icon class="demo-ruleForm">
            ...
            <el-col :span="12">
              <div class="grid-content bg-purple">
                <el-form-item label="项目经理：" prop="projectManagerName" :label-width="formLabelWidth">
                  <el-select class="zzt_zbfs_selectbox"  v-model="form.projectManagerName" placeholder="请选择">
                    <el-option
            ...
            <el-col :span="12">
              <el-form-item label="所属部门：" prop="departmentName" :label-width="formLabelWidth">
                <el-select class="zzt_zbfs_selectbox"  v-model="form.departmentName" placeholder="请选择">
                  <el-option
        ...
        if (valid) {
          ...
          this.axios.post('project-infos', this.form).then((res) => {
            if (flag == 0) {
              ...
              this.$router.push({path: '/archives/archived-file', query: {objectId: this.addObject, btn: true, inforOnMethod: this.form.inforOnMethod}})
            } else {
