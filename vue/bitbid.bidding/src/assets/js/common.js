...
// 矿权文件上传路径
const miningLoadUrl = process.env.PUBRESOURCE_BASE_API;
...
const downloadFileMining = (fileName, filePath) => {
  window.open(`${miningLoadUrl}download?fileName=${encodeURI(fileName)}&filePath=${filePath}`)
}

export  { checkResponse, loadUrl, fileSize, addtitle, miningLoadUrl, downloadFile, downloadFileMining, parseDate }
