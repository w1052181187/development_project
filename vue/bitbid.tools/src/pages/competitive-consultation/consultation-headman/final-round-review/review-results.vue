    ...
    <div class="score_bigbox">
      <el-table
        ...
        <el-table-column
          ...
          width="150"
          align="center"
          v-for="(tabScore, index) in tabScoreTitle" :key="index">
...
export default {
  ...
  methods: {
    ...
    reviewResultsLists () {
      ...
      consultingReview.reviewResultsList(url).then((res) => {
    ...
    checkSample () {
      let reResult = false
      console.log(this.tabScoreTitle)
    ...
    submitBtn () {
      ...
      if (!backV) {
        consultingReview.rationalitySubmit().then(() => {
