<template>
  <div id="quaSummNegHeadman" class="content_bgibox">
    <!--评审-->
...
export default {
  ...
  methods: {
    ...
    tableReviewSummaryClick (rowId) {
      ...
      this.tabReviewJudgesListLists(rowId)
    },
    // 表格点击事件(评审项目汇总结果)
    ...
    tabReviewJudgesListLists () {
      ...
      consultingReview.ReviewProjectSummaryList(this.tableReviewSummaryId, url).then((res) => {
