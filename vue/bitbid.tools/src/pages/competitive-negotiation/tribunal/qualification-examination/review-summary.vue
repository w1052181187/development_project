...
export default {
  ...
  methods: {
    ...
    tabReviewJudgesListLists (objectId) {
      ...
      qualificationReview.ReviewProjectSummaryList(objectId, params).then((res) => {
        this.tabReviewProjectSummary = res.data.ResultList
        if (this.tabReviewProjectSummary) {
    ...
    tabReviewJudgesLists (tenderId, itemId) {
      ...
      qualificationReview.tabReviewJudgesList(tenderId, itemId, params).then((res) => {
