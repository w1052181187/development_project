...
export default {
  ...
  methods: {
    ...
    tabReviewJudgesListLists () {
      ...
      qualificationReview.ReviewProjectSummaryList(this.tableReviewSummaryId, url).then((res) => {
    ...
    tabReviewJudgesLists (tenderId, itemId) {
      ...
      qualificationReview.tabReviewJudgesList(tenderId, itemId, url).then((res) => {
