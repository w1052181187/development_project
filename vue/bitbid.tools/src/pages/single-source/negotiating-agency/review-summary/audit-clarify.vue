    ...
    <el-row>
      ...
      <el-col :span="20" class="negSummrightbox">
        ...
        <div class="zztdemo_ruleForm">
          ...
          <!--<div class="proinfobox" v-if="startStatus">-->
            <!--<span class="line_bigbox"></span>-->
            <!--<span class="title_bigbox">下一轮报价</span>-->
          <!--</div>-->
          <!--<div style="padding: 20px 0;width: 70%" v-if="startStatus">-->
            <!--<el-table-->
              <!--:data="nextOfferData"-->
              <!--border-->
              <!--style="width: 100%">-->
...
import leftNavRecord from '@/components/common/single-source/left-nav-record'
