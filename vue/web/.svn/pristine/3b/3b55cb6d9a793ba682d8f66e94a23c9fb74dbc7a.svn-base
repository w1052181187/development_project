  ...
  <div id="rotate-add" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>添加违规公示</el-breadcrumb-item>
      </el-breadcrumb>
    ...
    <div class="contentbigbox">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="140px" class="demo-ruleForm">
        ...
        <el-form-item label="公示内容:" prop="content" class="form-ueditor">
...
export default {
  data () {
    return {
      ...
      rules: {
        title: [
          { required: true, message: '请填写公示名称', trigger: 'blur' },
    ...
    submitForm (name) {
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          infoManageViolation.save(this.ruleForm).then((res) => {
