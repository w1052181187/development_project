  ...
  <div id="bidwinupdate" class="smaincontent">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>变更中标候选人公示</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
            ...
            <tr>
              ...
              <td  colspan="2">
                <el-form-item prop="bidSectionCodes">
                  <el-input  v-model="winBidForm.bidSectionCodes" placeholder="请输入招标项目编号" v-bind:disabled="disableFlag"></el-input>
                </el-form-item>
              </td>
            </tr>
            <tr>
  ...
  methods: {
    ...
    detail () {
      bidwin.detail(this.$route.query.objectId).then((res) => {
        ...
        if (res.data.record.relatedCode !== null) {
          this.disableFlag = true
        }
        this.winBidForm.tenderExpandsInfo.originalInfoCode = res.data.record.code
    ...
    submitForm (name) {
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          this.winBidForm.publicityContent = this.$refs.change_ueditor.getContent()
          this.isSubmiting = true
          bidwin.change(this.winBidForm).then((res) => {
