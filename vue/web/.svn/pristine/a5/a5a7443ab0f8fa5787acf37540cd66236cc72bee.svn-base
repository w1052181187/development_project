        ...
        <el-form :model="addForm" :rules="rules" ref="addForm" :validate-on-rule-change="true">
          <table class="detailtable" style="border:none;">
            ...
            <tr style="height: 100px;">
              ...
              <td colspan="2">
                <upload-file @uploadSuccess="uploadSuccess" @deleteSuccess="deleteSuccess" :fileArrays="this.addForm.enterprise.fileInformations" fileType="1" isImage="1"></upload-file>
              </td>
              <td><i class="red">*</i>银行开户证明：</td>
              <td colspan="2">
                <upload-file @uploadSuccess="uploadSuccess" @deleteSuccess="deleteSuccess" :fileArrays="this.addForm.enterprise.fileInformations" fileType="2" isImage="1"></upload-file>
              </td>
            </tr>
            <tr>
...
export default{
  ...
  methods: {
    ...
    uploadSuccess (file, fileType) {
      this.addForm.enterprise.fileInformations = this.addForm.enterprise.fileInformations.filter(item => item.businessType !== fileType)
      this.addForm.enterprise.fileInformations.push(file)
    },
    deleteSuccess (fileId) {
      this.addForm.enterprise.fileInformations = this.addForm.enterprise.fileInformations.filter(item => item.relativePath !== fileId)
    }
  }
}
</script>
