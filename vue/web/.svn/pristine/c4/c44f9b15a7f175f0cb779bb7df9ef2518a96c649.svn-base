  ...
  <div id="industry-supervision">
    <div class="headertitle">
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>服务指南</el-breadcrumb-item>
      </el-breadcrumb>
      <!--面包屑-->
    </div>
    <div class="contentbigbox">
      <!--搜索 & 添加按钮-->
      <el-row>
        <el-button type="success"  class="addbutton" @click="addbutton"> + 添加服务指南</el-button>
...
export default {
  ...
  methods: {
    ...
    /** 新增 */
    addbutton () {
      this.$router.push({path: '/index/service-guide/add'})
    },
    /** 表格操作按钮 */
    handleTableBtn (row, type) {
      if (Object.is(type, 'del')) {
        ...
        this.$router.push({path: `/index/service-guide/detail/${row.objectId}`})
      } else if (Object.is(type, 'edit')) {
        this.$router.push({path: '/index/service-guide/update', query: {objectId: row.objectId}})
      }
    },
    /** 删除 */
    delete (row) {
