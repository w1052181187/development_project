...
public abstract class BasePageCircleListFragment<T> extends BaseFragment
		implements IForceListenRefreshExtend {
	...
	protected static final int UPDATE_DATA_UI = 10003;
	protected static final int DELETE_DATA_UI = 10004;
...
//			if (Common.isTargetTimeBefore(oldTime)) {
		...
		HttpUtil.get(url, null, new MyJsonHttpResponseHandler() {
			...
			public void onDataSuccess(int status, String mod, String message,
				...
				try {
					...
					list = gson.fromJson(mObj.optString("list"), new TypeToken<List<DynamicItemBean>>() {
					}.getType());
	...
	public void initDatas() {
		...
		if (mAdapter instanceof CircleChannelItemRecommendAdapter) {
			((CircleChannelItemRecommendAdapter)mAdapter).setCircleCommentHandleCallback(new CircleCommentHandleSuccessListener() {
