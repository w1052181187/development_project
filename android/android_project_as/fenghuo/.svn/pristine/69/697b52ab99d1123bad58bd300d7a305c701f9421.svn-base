...
public class CircleChannelItemAdapter extends BasePageListAdapter {
	...
	public CircleChannelItemAdapter(Activity activity, List list, boolean isShowDel, boolean isShowDelFav) {
		super(activity, list);
...
//						getDimensionPixelSize(R.dimen.common_round_corner)))
	...
	public CircleChannelItemAdapter(Activity activity, List list, boolean isShowDel, TextView tv) {
		super(activity, list);
		this.mContext = activity;
		this.isShowDel = false;
		mImageViewList = new ArrayList<ImageView>();
...
//					notifyDataSetChanged();
	...
	public static void setIsSelected(SparseBooleanArray isSelected) {
		CircleChannelItemAdapter.isSelected = isSelected;
	}
