...
public class DragAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageLoader.getInstance().displayImage(bean.getPic(), image, options);
//		if (Common.isTrue(App.getInst().getmNightModel())) {
//			image.setColorFilter(context.getResources().getColor(R.color.night_img_color), PorterDuff.Mode.MULTIPLY);
//			 
//		}
