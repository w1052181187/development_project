...
public class AutoPlayBigPicView {
	...
	public AutoPlayBigPicView(Activity context,List<ChannelItemBean> topic, OnClickListener onclick)
	{
		mContext = context;
		mTopic = topic;
...
//		          flp.height = max*58/100;
	         ...
	         { 
	        	  ...
	        	  if (!isNoPicModel) {
		        	  ImageLoader.getInstance().displayImage(mTopic.get(i).getImage_list(), image, new ImageLoadingListener(){
							@Override
