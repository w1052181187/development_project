...
import com.chengning.fenghuo.data.access.SettingDA;
...
public class SettingManager {
	...
	private int config_push_is_at;
	private int config_push_is_reply;
	private int config_push_is_dig;
	private int config_push_is_pm;
	private int config_push_is_fan;
	private int config_push_is_splendid;
	private String config_push_start_time;
	private String config_push_end_time;
	private int config_reply_access;
	...
	public static SettingBean getDefaultSettingBean() {
		...
		bean.setConfig_push_is_at(Common.TRUE);
		bean.setConfig_push_is_reply(Common.TRUE);
		bean.setConfig_push_is_dig(Common.TRUE);
		bean.setConfig_push_is_pm(Common.TRUE);
		bean.setConfig_push_is_fan(Common.FALSE);
		bean.setConfig_push_start_time("07:00");
		bean.setConfig_push_end_time("22:00");
		bean.setConfig_reply_access(0);
		return bean;
	}
