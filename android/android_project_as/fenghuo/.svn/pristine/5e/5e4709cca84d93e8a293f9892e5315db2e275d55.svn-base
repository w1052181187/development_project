...
public class ImagePickHelperForCircleBg {
	...
	public ImagePickHelperForCircleBg(final Activity activity, final String fileName){
		this.activity = activity;
		this.fileName = fileName;
		deleteFile();
	}

	public ImagePickHelperForCircleBg() {
	}
