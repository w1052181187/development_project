...
public class MyFocusExpandableListAdapter extends BaseExpandableListAdapter  implements
		SectionIndexer {
	...
	public MyFocusExpandableListAdapter(Activity context, List<UserInfoBean> list,
...
//		// test start
//		UserInfoBean b = mItemList.get(2);
//		for(int i = 0; i < 30; i++){
//			mItemList.add(b);
//		}
//		for(int i = 0; i < 30; i++){
//			mItemList.add(mItemList.get(0));
//		}
//		for(int i = 0; i < 30; i++){
//			mItemList.add(mItemList.get(4));
//		}
//		// test end
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView == null) {
			convertView = View.inflate(mContext, R.layout.item_user_group_add_member_child, null);
			...
			holder.alreadyAddBtn = (TextView) convertView.findViewById(R.id.already_add_btn);
		...
		holder.addBtn.setOnClickListener(mClick);
		holder.alreadyAddBtn.setOnClickListener(emptyOnClickListener);
		...
		if (bean != null) {
			...
			holder.alreadyAddBtn.setVisibility(View.GONE);

			holder.name.setTag(bean);
			holder.addBtn.setTag(bean);
		}
		return convertView;
	}
	...
	private OnClickListener childOnClickListener = new OnClickListener() {
	...
	private OnClickListener emptyOnClickListener = new OnClickListener() {
		
		@Override
		public void onClick(View v) {
			System.out.println("emptyOnClickListener");
		}
	};
