...
import com.chengning.fenghuo.widget.SettingFontDialog;
import com.chengning.fenghuo.widget.SettingFontDialog.SettingFontDialogItemClick;
import com.chengning.fenghuo.widget.SettingOfflineProgress;
...
public class SettingActivity extends BaseFragmentActivity {
	...
	private RelativeLayout mCommentAuthority;
	private View mCommentAuthorityLine;
	...
	public void initViews() {
		...
		mCommentAuthority = (RelativeLayout) findViewById(R.id.setting_comment_authority_rl);
		mCommentAuthorityLine = findViewById(R.id.setting_comment_authority_view);
	...
	public void initDatas() {
		...
		mCommentAuthority.setVisibility(app.isLogin() ? View.VISIBLE : View.GONE);
		mCommentAuthorityLine.setVisibility(app.isLogin() ? View.VISIBLE : View.GONE);
...
//	    mOfflineProgress.setProgress(progress)
		...
		mCommentAuthority.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(getActivity(),SetCommentPermissionActivity.class);
				startActivity(intent);
			}
		});
	}
