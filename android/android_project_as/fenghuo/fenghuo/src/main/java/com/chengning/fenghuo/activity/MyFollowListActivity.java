...
public class MyFollowListActivity extends BasePageListActivity<UserInfoBean> {

	private View mView;

	@Override
	public BaseFragmentActivity buildContext() {
		return MyFollowListActivity.this;
	}

	@Override
	public String buildUrl() {
		return JUrl.SITE + JUrl.URL_GET_MILITARY_FANS_FOLLOW;
	}

	@Override
	public BaseAdapter buildAdapter(FragmentActivity activity, List list) {
		return new MyFansListAdapter(activity, list,
	...
	public View configContentView() {
		mView = LayoutInflater.from(getActivity()).inflate(
				R.layout.activity_base_list, null, false);
		return mView;
	}
