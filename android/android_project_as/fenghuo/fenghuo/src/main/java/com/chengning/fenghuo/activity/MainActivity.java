...
import com.chengning.fenghuo.adapter.FragmentTabAdapterExtend;
import com.chengning.fenghuo.event.ShareImgEvent;
import com.chengning.fenghuo.fragment.CircleFragment;
import com.chengning.fenghuo.fragment.HomeFragment;
import com.chengning.fenghuo.fragment.InviteFragment;
import com.chengning.fenghuo.fragment.MyFragment;
import com.chengning.fenghuo.service.UpdateBadgeService;
import com.chengning.fenghuo.util.Common;
import com.chengning.fenghuo.util.StatusBarUtil;
import com.chengning.fenghuo.util.UIHelper;
import com.chengning.fenghuo.util.UmengShare;
import com.chengning.fenghuo.widget.FirstRunPage;
...
//	private View mContactRed;
	...
	public void initViews() {
		...
		mTabCircle = (ImageRadioButton) findViewById(R.id.tab_circle);
...
//		new FeedbackAgent(getActivity()).sync();
	...
	private void addFragment() {
		...
		mFragmentsList.add(mCircleFragment);
							...
							switch (index) {
								...
								case INDEX_CIRCLE:
									if (null != mCircleFragment) {
										mCircleFragment.refreshCircleLoginChange();
	...
	public void installListeners() {
		...
		mTabCircle.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
		...
		if(mPreTouchIndex == index && index != INDEX_WODE){ 
    		switch (index) {
				...
				case INDEX_INVITE:
					...
					break;
				case INDEX_CIRCLE :
					mCircleFragment.refreshCurChannel();
					break;
