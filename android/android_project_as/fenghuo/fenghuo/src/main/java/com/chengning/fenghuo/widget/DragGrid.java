...
public class DragGrid extends GridView {
	...
	public void init(Context context){
		...
		// TODO(spacing new api)
//		mVerticalSpacing = getVerticalSpacing();
//		mHorizontalSpacing = getHorizontalSpacing();
		
//		//将布局文件中设置的间距dip转为px
		mHorizontalSpacing = DisplayUtil.getInst().dip2px(mHorizontalSpacing);
		mVerticalSpacing = DisplayUtil.getInst().dip2px(mVerticalSpacing);
	}
	...
	public void setOnItemClickListener(final MotionEvent ev) {
		setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				TextView dragTextView = (TextView)dragViewGroup.findViewById(R.id.item_channel_tab_name);
