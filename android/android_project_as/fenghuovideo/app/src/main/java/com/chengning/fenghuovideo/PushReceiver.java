...
import com.chengning.fenghuovideo.data.bean.PushLCBean;
...
public class PushReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if ("com.chengning.fenghuovideo.PUSH".equals(action) && bundle != null
				&& bundle.containsKey("com.avos.avoscloud.Data")) {
			if (!Common.isTrue(SettingManager.getInst().getSettingBean().getConfig_push_enable()) || Common.isMIUI()) {
				Log.i(TAG, "推送已关闭");
				return;
			}
			Log.i(TAG, "onReceive");
