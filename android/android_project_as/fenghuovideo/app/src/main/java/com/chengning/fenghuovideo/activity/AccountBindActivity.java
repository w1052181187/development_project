...
import com.chengning.fenghuovideo.widget.CommonHintDialog;
import com.chengning.fenghuovideo.widget.CommonHintDialog.CommonDialogLitener;
...
public class AccountBindActivity extends BaseFragmentActivity {
		...
		mPhoneBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (TextUtils.equals(mPhoneTv.getText(),"未绑定")) {
					...
					showRemovePhoneBindDialog((BaseFragmentActivity)getActivity());
				}
			}
		});
		...
		mQQBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (TextUtils.equals(mQQTv.getText(), "未绑定")) {
					...
					showRemoveBindDialog((BaseFragmentActivity)getActivity(), BindType.QQ);
				}
			}
		});
		...
		mSinaBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (TextUtils.equals(mSinaTv.getText(), "未绑定")) {
					...
					showRemoveBindDialog((BaseFragmentActivity)getActivity(), BindType.SINA);
				}
			}
		});
		...
		mWeixinBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (TextUtils.equals(mWeixinTv.getText(), "未绑定")) {
					...
					showRemoveBindDialog((BaseFragmentActivity)getActivity(),BindType.WEIXIN);
				}
			}
		});
	...
	protected void showRemovePhoneBindDialog(final BaseFragmentActivity activity) {
		...
		dialog.showAllowingStateLoss(activity, getSupportFragmentManager(),
	 ...
	 * 显示解除绑定对话框
	 */
	protected void showRemoveBindDialog(final BaseFragmentActivity activity, final BindType type) {
