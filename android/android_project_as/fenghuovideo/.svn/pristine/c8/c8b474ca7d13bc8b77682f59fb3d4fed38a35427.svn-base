package com.chengning.fenghuovideo.highlighttext;
 ...
 */
public class MyLinkMovementMethod_ extends ScrollingMovementMethod {
	private static final int CLICK = 1;
	private static final int UP = 2;
	private static final int DOWN = 3;

	public abstract interface TextClickedListener {
		public abstract void onTextClicked(View v, MotionEvent event);
	}
	...
	public boolean onTouchEvent(TextView widget, Spannable buffer, MotionEvent event) {
		...
		if (action == MotionEvent.ACTION_UP || action == MotionEvent.ACTION_DOWN) {
			...
			if (link.length != 0) {
				...
				if (action == MotionEvent.ACTION_UP) {
					if (listener != null)
						listener.onTextClicked(widget, event);
				}
//				return false;
			}
		}
	...
	public static MovementMethod getInstance() {
		if (sInstance == null)
			sInstance = new MyLinkMovementMethod_();

		return sInstance;
	}

	private static MyLinkMovementMethod_ sInstance;
