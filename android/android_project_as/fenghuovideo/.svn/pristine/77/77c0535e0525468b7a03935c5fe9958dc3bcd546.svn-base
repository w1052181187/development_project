...
import com.chengning.fenghuovideo.data.bean.AdStartBean;
import com.chengning.fenghuovideo.data.bean.InitBean;
...
public class SplashActivity extends BaseActivity{
	...
	public void initDatas() {
		...
		if(TextUtils.isEmpty(defaultSavedImage)){
			defaultSavedImage = "mipmap://" + R.mipmap.splash_pic;
