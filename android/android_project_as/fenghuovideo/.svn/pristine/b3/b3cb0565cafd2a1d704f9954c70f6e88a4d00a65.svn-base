...
public class JUrl extends BaseJUrl{
	...
	public static String FilePathTemp = Environment.getExternalStorageDirectory().getAbsolutePath()+"/fenghuovideo/temp";
	public static String FilePathImageCache = Environment.getExternalStorageDirectory().getAbsolutePath()+"/fenghuovideo/cache/image";
	public static  String FilePath = Environment.getExternalStorageDirectory().getAbsolutePath()+"/fenghuovideo";
...
//	public static final String SITE_ONLINE = "http://if.pp78.com/";
	...
	public static final String API = "video1.0/";
