...
import com.shenyuan.militarynews.views.UpgradeDialog.DialogOnClickListener;
...
//	public static void showHints(FragmentActivity mContext, DirectoratePointBean task,
...
//	}
//
//	public static void showHints(FragmentActivity mContext, DirectoratePointBean data,
//								 PointActionType action) {
//		if(data != null){
//			showUpdateDialog(mContext, data, action);
//		}
//	}
	...
	public static void showHints(FragmentActivity mContext,
			DirectoratePointBean mData, PointActionType action){
