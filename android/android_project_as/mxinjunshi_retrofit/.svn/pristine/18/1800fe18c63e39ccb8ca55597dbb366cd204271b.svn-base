...
public class HomeNewContentPopup {
	...
	public void show(final Activity activity, final View v, Handler handler, final String text) {
	...
	public static void handleHttpListData(final Activity activity, final View v,
			final Handler handler, final int newCount) {
...
//			String text = "";
	...
	public static void handleFirstCommentList(Activity activity) {
