...
public class ProgressRefreshView {
	...
	public ProgressRefreshView(Activity context, boolean isSingleInActivity) {
		this.mContext = context;
		mLayout = (RelativeLayout) context.findViewById(R.id.progress_refresh_layout);
		initView(mLayout);
	}
	...
	private void initView(RelativeLayout mLayout) {
