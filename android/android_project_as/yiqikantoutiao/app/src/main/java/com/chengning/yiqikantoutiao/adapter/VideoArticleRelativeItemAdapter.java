...
public class VideoArticleRelativeItemAdapter extends BaseTypeListAdapter {
	...
	public VideoArticleRelativeItemAdapter(Activity activity, List list) {
		super(activity, list);
	...
	public VideoArticleRelativeItemAdapter(Activity activity, List list, AdDataManager ad, int adOffset) {
		super(activity, list);
	...
	public void handleLayout(final View convertView, final int position, Object obj,
		...
		// TODO(close image)
		final boolean closeImage = false;
