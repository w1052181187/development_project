...
import com.chengning.yiqikantoutiao.util.BrightnessTools;
...
public class ArticleMoreDialog extends BaseDialogFragment {
	...
	public void initListener() {
		...
		mShareWeibo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (null != mArticleBean) {
					UmengShare.getInstance().shareToWeibo(getActivity(), UmengShare.getInstance().translateObjectToShareBean(mArticleBean));
				}
			}
		});
