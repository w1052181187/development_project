...
import com.chengning.yiqikantoutiao.widget.ModifyPwdSuccessDialog;
import com.chengning.yiqikantoutiao.widget.ModifyPwdSuccessDialog.ModifyPwdSunccessListener;
...
public class PwdModifyActivity extends BaseFragmentActivity {
	...
	private void showHintDialog() {
		...
		dialog.show(getSupportFragmentManager(), ModifyPwdSuccessDialog.class.getSimpleName());
	}
