...
public final class dbProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.chengning.yiqikantoutiao.db.provider.dbProvider";
    ...
    private enum UriType {
        ...
        TABLE_NOLOGIN_READ_ARTICLE_NUMBER(table_nologin_read_article_number.TABLE_NAME, table_nologin_read_article_number.TABLE_NAME, table_nologin_read_article_number.TYPE_ELEM_TYPE),
        TABLE_NOLOGIN_READ_ARTICLE_NUMBER_ID(table_nologin_read_article_number.TABLE_NAME + "/#", table_nologin_read_article_number.TABLE_NAME, table_nologin_read_article_number.TYPE_DIR_TYPE);
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            table_nologin_read_article_number.createTable(db);
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            table_nologin_read_article_number.upgradeTable(db, oldVersion, newVersion);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            ...
            case TABLE_NOLOGIN_READ_ARTICLE_NUMBER_ID:
            ...
            case TABLE_NOLOGIN_READ_ARTICLE_NUMBER:
        ...
        try {
            ...
            switch (uriType) {
                ...
                case TABLE_NOLOGIN_READ_ARTICLE_NUMBER:
                	hasError = false;
               		lastE = null;
                    insertStmt = db.compileStatement(table_nologin_read_article_number.getBulkInsertString());
                    for (ContentValues value : values) {
                        table_nologin_read_article_number.bindValuesInBulkInsert(insertStmt, value);
                        try {
                            insertStmt.execute();
						} catch (Exception e) {
							hasError = true;
