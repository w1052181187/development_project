package com.cmstop.jstt.service;
...
import com.cmstop.jstt.beans.data.BadgeBean;
...
//	public final long UPDATE_TIME = 1*60*1000;
	...
	void getBadgeCount(String maxid) {
		...
		HttpUtil.get(JUrl.SITE + JUrl.URL_GET_NEW_ARTICLE_COUNT, params, new MyStatusResponseHandler() {
