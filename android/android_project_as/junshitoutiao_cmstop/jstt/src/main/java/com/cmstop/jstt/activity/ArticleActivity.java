...
import com.cmstop.jstt.views.ArticleMoreDialog;
import com.cmstop.jstt.views.ArticleRelativeBottom;
import com.cmstop.jstt.views.ArticleRelativeBottom2;
	...
	public void installListeners() {
		...
		mTitleBar.setRightButtonOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				mSettingDialog.showAllowingStateLoss(ArticleActivity.this, getSupportFragmentManager(), ArticleMoreDialog.class.getSimpleName());
