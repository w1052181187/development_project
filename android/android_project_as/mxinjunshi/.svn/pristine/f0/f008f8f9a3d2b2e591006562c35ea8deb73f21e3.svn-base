...
public abstract class BaseListServer<T> {

	private Context mContext;
	private ContentResolver mResolver;
	private Uri mUri;

	protected BaseListServer(Context context, Uri uri) {
		mContext = context;
		mResolver = context.getContentResolver();
		mUri = uri;
	}

	protected abstract String buildDeleteWhere(T t);
	 ...
	 * </pre>
	 */
	protected abstract String[] buildDeleteSelectionArgs(T t);
	 ...
	 * </pre>
	 */
	protected abstract ContentValues buildInsertValues(T t);
	 ...
	 * </pre>
	 */
	protected abstract T buildQueryValues(Cursor cursor);
