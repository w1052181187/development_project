...
package com.chengning.common.widget.wheel;
...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(dip2px(TEXT_SIZE));
		}
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(dip2px(TEXT_SIZE));
			valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
		}

		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val_kankan);
		}
		...
		setBackgroundResource(R.drawable.wheel_bg_kankan);
	}
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		if (maxLength > 0) {
			double textWidth = Math.ceil(Layout.getDesiredWidth("汉", itemsPaint));
