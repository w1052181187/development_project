...
import com.chengning.molibaoku.db.provider.dbContent.table_login;
import com.chengning.molibaoku.db.provider.dbContent.table_setting;
import com.chengning.molibaoku.db.provider.dbContent.table_local_state;
...
public final class dbProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.chengning.molibaoku.db.provider.dbProvider";
