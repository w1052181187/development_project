...
import com.handmark.pulltorefresh.library.extras.PullToRefreshFootView;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected PullToRefreshFootView mFooterView;
	
	protected int mMinItemCount;
	...
	public PullToRefreshFootView getFootView(){
		return mFooterView;
	}
	...
	public void setMinItemCount(int min)
	{
		mMinItemCount = min;
	}
	...
	public void CheckListSize(int count)
	{
		...
		{
			setFootLoadVisibility(View.INVISIBLE);
		}else
		{
			setFootLoadVisibility(View.INVISIBLE);
		}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mFooterView = new PullToRefreshFootView(context);
