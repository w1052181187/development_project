package com.shenyuan.dingsheng.provider;

import com.shenyuan.dingsheng.provider.util.ColumnMetadata;
...
public abstract class dbContent {
    ...
    public static final class tablenews extends dbContent {
        ...
        public static enum Columns implements ColumnMetadata {
            ...
            FAVORITE_TIME("favorite_time", "text"),
            LOADSTATE("loadstate", "integer"),
            TYPE("type", "integer"),
            CHANNEL("channel", "text"),
            MULCHANNEL("mulchannel", "text"),
            PAGE("page", "integer"),
            ISSLIDE("isslide", "integer");
        ...
        // Version 17 : Creation of the table
        public static void upgradeTable(SQLiteDatabase db, int oldVersion, int newVersion) {
            if (dbProvider.ACTIVATE_ALL_LOGS) {
        ...
        static void bindValuesInBulkInsert(SQLiteStatement stmt, ContentValues values) {
            ...
            value = values.getAsString(Columns.FAVORITE_TIME.getName());
            stmt.bindString(i++, value != null ? value : "");
            ...
            stmt.bindString(i++, value != null ? value : "");
            value = values.getAsString(Columns.MULCHANNEL.getName());
            stmt.bindString(i++, value != null ? value : "");
            stmt.bindLong(i++, values.getAsLong(Columns.PAGE.getName()));
            stmt.bindLong(i++, values.getAsLong(Columns.ISSLIDE.getName()));
        }
    }
}
