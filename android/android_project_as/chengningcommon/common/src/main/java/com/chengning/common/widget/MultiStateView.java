...
public class MultiStateView extends FrameLayout {
    ...
    /**
     * Returns the {@link View} associated with the {@link com.chengning.common.widget.MultiStateView.ViewState}
     *
     * @param state The {@link com.chengning.common.widget.MultiStateView.ViewState} with to return the view for
     * @return The {@link View} associated with the {@link com.chengning.common.widget.MultiStateView.ViewState}, null if no view is present
     */
    @Nullable
    ...
    /**
     * Returns the current {@link com.chengning.common.widget.MultiStateView.ViewState}
     *
     * @return
     */
    ...
    /**
     * Sets the current {@link com.chengning.common.widget.MultiStateView.ViewState}
     *
     * @param state The {@link com.chengning.common.widget.MultiStateView.ViewState} to set {@link MultiStateView} to
     */
    ...
    /**
     * Shows the {@link View} based on the {@link com.chengning.common.widget.MultiStateView.ViewState}
     */
     ...
     * @param state         The {@link com.chengning.common.widget.MultiStateView.ViewState}to set
     * @param switchToState If the {@link com.chengning.common.widget.MultiStateView.ViewState} should be switched to
     */
    ...
    /**
     * Sets the {@link View} for the given {@link com.chengning.common.widget.MultiStateView.ViewState}
     *
     * @param view  The {@link View} to use
     * @param state The {@link com.chengning.common.widget.MultiStateView.ViewState} to set
     */
     ...
     * @param emptyStr
     */
    public void setEmptyHint(String emptyStr){
    	TextView textView = (TextView) mEmptyView.findViewById(R.id.multistateview_empty);
     ...
     * @param color
     */
    public void setEmptyHintColor(int color){
    	TextView textView = (TextView) mEmptyView.findViewById(R.id.multistateview_empty);
     ...
     */
    public void setEmptyHintColorResource(int resid){
    	setEmptyHintColor(getContext().getResources().getColor(resid));
    }
    ...
    public void setRefreshOnClickListener(OnClickListener listener) {
    	getView(ViewState.ERROR).findViewById(R.id.multistateview_touchRefresh).setOnClickListener(listener);
    }
}
