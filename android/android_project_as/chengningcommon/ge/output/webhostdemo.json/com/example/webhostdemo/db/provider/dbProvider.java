...
import com.example.webhostdemo.db.provider.dbContent.table_name_cache;
import com.example.webhostdemo.db.provider.dbContent.table_host_cache;
...
public final class dbProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.webhostdemo.db.provider.dbProvider";
    ...
    private enum UriType {
        TABLE_NAME_CACHE(table_name_cache.TABLE_NAME, table_name_cache.TABLE_NAME, table_name_cache.TYPE_ELEM_TYPE),
        TABLE_NAME_CACHE_ID(table_name_cache.TABLE_NAME + "/#", table_name_cache.TABLE_NAME, table_name_cache.TYPE_DIR_TYPE),
        TABLE_HOST_CACHE(table_host_cache.TABLE_NAME, table_host_cache.TABLE_NAME, table_host_cache.TYPE_ELEM_TYPE),
        TABLE_HOST_CACHE_ID(table_host_cache.TABLE_NAME + "/#", table_host_cache.TABLE_NAME, table_host_cache.TYPE_DIR_TYPE);
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            table_name_cache.createTable(db);
            table_host_cache.createTable(db);
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            table_name_cache.upgradeTable(db, oldVersion, newVersion);
            table_host_cache.upgradeTable(db, oldVersion, newVersion);
        }
        ...
        try {
            ...
            switch (uriType) {
                case TABLE_NAME_CACHE:
                	hasError = false;
               		lastE = null;
                    insertStmt = db.compileStatement(table_name_cache.getBulkInsertString());
                    for (ContentValues value : values) {
                        table_name_cache.bindValuesInBulkInsert(insertStmt, value);
                        try {
                            insertStmt.execute();
						} catch (Exception e) {
							hasError = true;
                ...
                case TABLE_HOST_CACHE:
                	hasError = false;
               		lastE = null;
                    insertStmt = db.compileStatement(table_host_cache.getBulkInsertString());
                    for (ContentValues value : values) {
                        table_host_cache.bindValuesInBulkInsert(insertStmt, value);
                        try {
                            insertStmt.execute();
						} catch (Exception e) {
							hasError = true;
