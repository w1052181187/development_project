...
public abstract class dbContent {
     ...
     * Created in version 1
     */
    public static final class table_nologin_read_article_number extends dbContent {

        private static final String LOG_TAG = table_nologin_read_article_number.class.getSimpleName();

        public static final String TABLE_NAME = "table_nologin_read_article_number";
        public static final String TYPE_ELEM_TYPE = "vnd.android.cursor.item/db-table_nologin_read_article_number";
        public static final String TYPE_DIR_TYPE = "vnd.android.cursor.dir/db-table_nologin_read_article_number";
        ...
        public static enum Columns implements ColumnMetadata {
            ...
            READED_TIME("readed_time", "integer");
        ...
        public static final String[] PROJECTION = new String[] {
                ...
                Columns.READED_TIME.getName()
        };

        private table_nologin_read_article_number() {
            // No private constructor
        }

        public static void createTable(SQLiteDatabase db) {
            if (dbProvider.ACTIVATE_ALL_LOGS) {
                Log.d(LOG_TAG, "table_nologin_read_article_number | createTable start");
            }
            db.execSQL("CREATE TABLE " + TABLE_NAME + " (" + Columns._ID.getName() + " " + Columns._ID.getType()+ " PRIMARY KEY AUTOINCREMENT" + ", " + Columns.NUMBER.getName() + " " + Columns.NUMBER.getType() + ", " + Columns.READED_TIME.getName() + " " + Columns.READED_TIME.getType() + ");");

            if (dbProvider.ACTIVATE_ALL_LOGS) {
                Log.d(LOG_TAG, "table_nologin_read_article_number | createTable end");
            }
        }
        ...
        public static void upgradeTable(SQLiteDatabase db, int oldVersion, int newVersion) {
            if (dbProvider.ACTIVATE_ALL_LOGS) {
                Log.d(LOG_TAG, "table_nologin_read_article_number | upgradeTable start");
            }
            ...
            if (dbProvider.ACTIVATE_ALL_LOGS) {
                Log.d(LOG_TAG, "table_nologin_read_article_number | upgradeTable end");
            }
        }

        static String getBulkInsertString() {
            return new StringBuilder("REPLACE INTO ").append(TABLE_NAME).append(" ( ").append(Columns.NUMBER.getName()).append(", ").append(Columns.READED_TIME.getName()).append(" ) VALUES (?, ?)").toString();
        }

        static void bindValuesInBulkInsert(SQLiteStatement stmt, ContentValues values) {
            int i = 1;
            stmt.bindLong(i++, values.getAsLong(Columns.NUMBER.getName()));
            stmt.bindLong(i++, values.getAsLong(Columns.READED_TIME.getName()));
        }
    }
}
