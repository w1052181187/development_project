...
import com.shenyuan.xinjunshipinlun.provider.dbContent.tablehomeitem;
import com.shenyuan.xinjunshipinlun.provider.dbContent.tablechannel;
import com.shenyuan.xinjunshipinlun.provider.dbContent.tablenews;
...
public final class dbProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.shenyuan.xinjunshipinlun.provider.dbProvider";
    ...
    private enum UriType {
        TABLEHOMEITEM(tablehomeitem.TABLE_NAME, tablehomeitem.TABLE_NAME, tablehomeitem.TYPE_ELEM_TYPE),
        TABLEHOMEITEM_ID(tablehomeitem.TABLE_NAME + "/#", tablehomeitem.TABLE_NAME, tablehomeitem.TYPE_DIR_TYPE),
        TABLECHANNEL(tablechannel.TABLE_NAME, tablechannel.TABLE_NAME, tablechannel.TYPE_ELEM_TYPE),
        TABLECHANNEL_ID(tablechannel.TABLE_NAME + "/#", tablechannel.TABLE_NAME, tablechannel.TYPE_DIR_TYPE),
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            tablehomeitem.createTable(db);
            tablechannel.createTable(db);
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            tablehomeitem.upgradeTable(db, oldVersion, newVersion);
            tablechannel.upgradeTable(db, oldVersion, newVersion);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case TABLEHOMEITEM_ID:
            case TABLECHANNEL_ID:
            case TABLENEWS_ID:
        ...
        try {
            ...
            switch (uriType) {
                case TABLEHOMEITEM:
                	hasError = false;
               		lastE = null;
                    insertStmt = db.compileStatement(tablehomeitem.getBulkInsertString());
                    for (ContentValues value : values) {
                        tablehomeitem.bindValuesInBulkInsert(insertStmt, value);
                        try {
                            insertStmt.execute();
						} catch (Exception e) {
							hasError = true;
                ...
                case TABLECHANNEL:
                	hasError = false;
               		lastE = null;
                    insertStmt = db.compileStatement(tablechannel.getBulkInsertString());
                    for (ContentValues value : values) {
                        tablechannel.bindValuesInBulkInsert(insertStmt, value);
                        try {
                            insertStmt.execute();
						} catch (Exception e) {
							hasError = true;
