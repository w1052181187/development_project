...
public class NiceVideoPlayer extends FrameLayout
    ...
    private ViewGroup mTinyWindowParent;
    ...
    public void enterFullScreen() {
        ...
        if (mCurrentMode == MODE_TINY_WINDOW) {
            if(mTinyWindowParent != null){
                mTinyWindowParent.removeView(mContainer);
            }else{
    ...
    public boolean exitFullScreen() {
        if (mCurrentMode == MODE_FULL_SCREEN) {
            ...
            if(mTinyWindowParent != null){
                mTinyWindowParent.addView(mContainer, params);
    ...
    public void setTinyWindowParent(ViewGroup parent){
        this.mTinyWindowParent = parent;
    }
    ...
    public void enterTinyWindow() {
        ...
        ViewGroup contentView = mTinyWindowParent != null ? mTinyWindowParent :
                (ViewGroup) NiceUtil.scanForActivity(mContext)
                .findViewById(android.R.id.content);
...
//        params.bottomMargin = NiceUtil.dp2px(mContext, 8f);
        ...
        // 小窗口的宽度为屏幕宽度的100%，长宽比默认为16:9，右边距、下边距为0dp。
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(
                (int) (NiceUtil.getScreenWidth(mContext) * 1f),
                (int) (NiceUtil.getScreenWidth(mContext) * 1f * 9f / 16f));
        params.gravity = Gravity.TOP | Gravity.START;
        params.rightMargin = NiceUtil.dp2px(mContext, 0f);
        params.bottomMargin = NiceUtil.dp2px(mContext, 0f);
