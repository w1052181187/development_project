...
public class TenderHistoryAdapter extends PageActivityAdapter {//投标协助历史记录
    ...
    public TenderHistoryAdapter(Context context, List<HelpTenderHistoryReusltBean.ItemBean> historyInfo, TenderHelpFiring tenderHelpFiring) {
        super(context);
        this.context = context;
        this.historyInfo = historyInfo;
        this.tenderHelpFiring = tenderHelpFiring;
        ...
        if (holder instanceof ItemHolder) {
            ...
            ((ItemHolder)holder).deleteHistory.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    tenderHelpFiring.deleteTenderHelp(id);
                }
            });
        }
    }
