...
public class HeaderWaveHelper {
    ...
    private float mDefaultWaterLevelRatioF = 0.35f;
    private float mDefaultWaterLevelRatioT = 0.35f;
    //波浪大小振幅 amplitudeRatio
    private float mDefaultAmplitudeRatioF = 0.09f;
    private float mDefaultAmplitudeRatioT = 0.09f;
    //floatView 旋转调整角
        ...
        waveShiftAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                if (mFloatView != null) {
                    ...
                    mFloatView.setTranslationY(value + DensityUtil.dip2px(25));
