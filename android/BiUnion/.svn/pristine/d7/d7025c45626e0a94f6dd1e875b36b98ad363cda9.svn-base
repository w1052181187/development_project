...
public class MessagePop extends BasePop implements RadioLayout.OnRadioLayoutOnClickListener {
    ...
    public MessagePop(Context context) {
        super(context);
        onMessagePopListener = (OnMessagePopListener) context;
    }
