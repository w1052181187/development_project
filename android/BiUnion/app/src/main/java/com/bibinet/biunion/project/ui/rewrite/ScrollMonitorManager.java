package com.bibinet.biunion.project.ui.rewrite;
...
public class ScrollMonitorManager extends LinearLayoutManager {

    private RecyclerView.Recycler mRecycler;

    public ScrollMonitorManager(Context context) {
        super(context);
    }
