...
public class PushBeautyDialog extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mWhite.setText(String.valueOf(SharedPresUtils.getWhiteValue(getActivity().getApplicationContext())));
        mWhiteBar.setProgress(SharedPresUtils.getWhiteValue(getActivity().getApplicationContext()));
        mSkin.setText(String.valueOf(SharedPresUtils.getBuffing(getActivity().getApplicationContext())));
        mSkinBar.setProgress(SharedPresUtils.getBuffing(getActivity().getApplicationContext()));
        mRuddy.setText(String.valueOf(SharedPresUtils.getRuddy(getActivity().getApplicationContext())));
        mRuddyBar.setProgress(SharedPresUtils.getRuddy(getActivity().getApplicationContext()));
        mCheekPink.setText(String.valueOf(SharedPresUtils.getCheekpink(getActivity().getApplicationContext())));
        mCheekPinkBar.setProgress(SharedPresUtils.getCheekpink(getActivity().getApplicationContext()));
        mSlimFace.setText(String.valueOf(SharedPresUtils.getSlimFace(getActivity().getApplicationContext())));
        mSlimFaceBar.setProgress(SharedPresUtils.getSlimFace(getActivity().getApplicationContext()));
        mShortenFace.setText(String.valueOf(SharedPresUtils.getShortenFace(getActivity().getApplicationContext())));
        mShortenFaceBar.setProgress(SharedPresUtils.getShortenFace(getActivity().getApplicationContext()));
        mBigEye.setText(String.valueOf(SharedPresUtils.getBigEye(getActivity().getApplicationContext())));
        mBigEyeBar.setProgress(SharedPresUtils.getBigEye(getActivity().getApplicationContext()));
        return view;
    }
...
//                        }
                        SharedPresUtils.setBeautyOn(getActivity().getApplicationContext(), selected);
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            try{
                ...
                if(mCheekPinkBar.getId() == seekBarId) {
                    ...
                    SharedPresUtils.setCheekPink(getActivity().getApplicationContext(), progress);
                    ...
                    SharedPresUtils.setWhiteValue(getActivity().getApplicationContext(), progress);
                    ...
                    SharedPresUtils.setBuffing(getActivity().getApplicationContext(), progress);
                    ...
                    SharedPresUtils.setRuddy(getActivity().getApplicationContext(), progress);
                    ...
                    SharedPresUtils.setSlimFace(getActivity().getApplicationContext(), progress);
                    ...
                    SharedPresUtils.setBigEye(getActivity().getApplicationContext(), progress);
                }
            } catch (IllegalArgumentException e) {
                e.printStackTrace();
            } catch (IllegalStateException e) {
