...
public class MoreProjectAdapter extends PageActivityAdapter {
    ...
    public MoreProjectAdapter(Activity context, List<InformationItemsModel> socailInfos, InformationBean informationBean) {
        super(context);
...
//            View view = inflater.inflate(R.layout.adapter_more_project, parent, false);
    ...
    protected void onChildBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ItemHolder) {
            ...
            if (informationBean.getId() == InformationConfig.ICT_TENDER_RM) {
                h.typeV.setVisibility(View.GONE);
            } else {
                h.typeV.setVisibility(View.VISIBLE);
    ...
    class ItemHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.ada_more_project_type)
        View typeV;
